...
class ClientController extends Controller
{
    ...
    public function store(Request $request)
    {
        if ($request -> isMethod('POST')) {
            ...
            $client->chif_aff_1 = str_replace(' ', '', $request->input('chif_aff_1'));
            $client->chif_aff_2 = str_replace(' ', '', $request->input('chif_aff_2'));
            $client->chif_aff_3 = str_replace(' ', '', $request->input('chif_aff_3'));
            $client->chif_aff_4 = str_replace(' ', '', $request->input('chif_aff_4'));
