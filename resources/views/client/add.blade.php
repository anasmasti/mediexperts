...
<div class="card card-dark">
    ...
    <div class="card-header">
        ...
        <!-- /.card-header -->
    <form role="form" name="f" action="/add-cl" method="POST">
    ...
    <div class="row">
        ...
        @if (session()->has('warning'))
            <div class="alert alert-warning alert-dismissible col-12">
                ...
                <span>Veuillez Associer des actionnaires !<br>
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>N° RC entreprise</label>
            <input class="form-control {{ $errors->has('nrc_entrp') ? ' is-invalid' : '' }}" value="{{old('nrc_entrp')}}" type="text" name="nrc_entrp" min="0" maxlength="20" onkeypress="return isNumberKey(event)" placeholder="N° RC entreprise" >
        ...
        <div class="form-group col-lg-9 col-sm-12"><label>Raison social</label>
            <input class="form-control {{ $errors->has('raisoci') ? ' is-invalid' : '' }}" value="{{old('raisoci')}}" type="text" name="raisoci" maxlength="100" placeholder="Raison social" >
        ...
        <div class="form-group col-lg-9 col-sm-12"><label>Abréviation raison social</label>
            <input class="form-control {{ $errors->has('rais_abrev') ? ' is-invalid' : '' }}" value="{{old('rais_abrev')}}" type="text" name="rais_abrev" maxlength="50" placeholder="Raison social" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Forme juridique</label>
            <input class="form-control {{ $errors->has('formjury') ? ' is-invalid' : '' }}" value="{{old('formjury')}}" type="text" name="formjury" maxlength="50" placeholder="Forme juridique" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Date création</label>
            <input class="form-control {{ $errors->has('dt_creat') ? ' is-invalid' : '' }}" value="{{old('dt_creat')}}" type="text" name="dt_creat" onmouseover="(this.type='date')" id="date-more" placeholder="Date création" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Capital social</label>
            <input class="form-control {{ $errors->has('capt_soci') ? ' is-invalid' : '' }}" value="{{old('capt_soci')}}" type="text" name="capt_soci" maxlength="20" onkeypress="return isNumberKey(event)" placeholder="Capital social" >
        ...
        <div class="form-group col-lg-3 col-sm-12">
            ...
            @if (count($giac)==0)
                <div class="text-danger txt-sm">Veuillez d'abord ajouter un GIAC</div>
            @endif
        ...
        <div class="form-group col-lg-6 col-sm-12"><label>Objet social</label><input class="form-control {{ $errors->has('obj_soci') ? ' is-invalid' : '' }}" value="{{old('obj_soci')}}" type="text" name="obj_soci" maxlength="50" placeholder="Objet social" >
        ...
        <div class="form-group col-lg-6 col-sm-12"><label>Secteur d'activité</label>
            <input class="form-control {{ $errors->has('sect_activ') ? ' is-invalid' : '' }}" value="{{old('sect_activ')}}" type="text" name="sect_activ" placeholder="Secteur d'activité" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>ICE</label>
            <input class="form-control {{ $errors->has('ice') ? ' is-invalid' : '' }}" type="text" value="{{old('ice')}}" name="ice" min="0" maxlength="50" onkeypress="return isNumberKey(event)" placeholder="ICE" >
            @if ($errors->has('ice'))
                <span class="invalid-feedback" role="alert">
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Identifiant fiscal</label>
            <input class="form-control {{ $errors->has('id_fiscal') ? ' is-invalid' : '' }}" value="{{old('id_fiscal')}}" type="text" name="id_fiscal" min="0" maxlength="20" onkeypress="return isNumberKey(event)" placeholder="Identifiant fiscal" >
        ...
        {{-- <div class="form-group col-lg-3 col-sm-12"><label>Identifiant entreprise</label>
            <input class="form-control {{ $errors->has('id_entrp') ? ' is-invalid' : '' }}" value="{{old('id_entrp')}}" type="text" name="id_entrp" min="0" maxlength="20" onkeypress="return isNumberKey(event)" placeholder="Identifiant entreprise" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>N° CNSS</label>
            <input class="form-control {{ $errors->has('ncnss') ? ' is-invalid' : '' }}" type="text" value="{{old('ncnss')}}" name="ncnss" min="0" maxlength="20" onkeypress="return isNumberKey(event)" placeholder="N° CNSS" >
            @if ($errors->has('ncnss'))
            <span class="invalid-feedback" role="alert">
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>N° patente</label>
            <input class="form-control {{ $errors->has('npatente') ? ' is-invalid' : '' }}" type="text" value="{{old('npatente')}}" name="npatente" min="0" maxlength="8" onkeypress="return isNumberKey(event)" placeholder="N° patente" >
        ...
        <div class="form-group col-lg-12 col-sm-12"><label>Siège social</label>
            <input class="form-control {{ $errors->has('sg_soci') ? ' is-invalid' : '' }}" type="text" value="{{old('sg_soci')}}" name="sg_soci" maxlength="100" placeholder="Siège social" >
        ...
        <div class="form-group col-lg-6 col-sm-12"><label>Ville siège</label>
            <input class="form-control {{ $errors->has('local_2') ? ' is-invalid' : '' }}" type="text" value="{{old('local_2')}}" name="local_2" maxlength="50" placeholder="Localisation 1" >
        ...
        {{-- <div class="form-group col-lg-6 col-sm-12"><label>Ville</label>
            <input class="form-control {{ $errors->has('ville') ? ' is-invalid' : '' }}" type="text" value="{{old('ville')}}" name="ville" maxlength="50" placeholder="Localisation 2" >
            @if ($errors->has('ville'))
            <span class="invalid-feedback" role="alert">
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Chiffre d'affaire - 1</label>
            <input class="form-control {{ $errors->has('chif_aff_1') ? ' is-invalid' : '' }}" type="number" value="{{old('chif_aff_1')}}" name="chif_aff_1" min="0" maxlength="13" onkeypress="return isNumberKey(event)" placeholder="en DH" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Chiffre d'affaire - 2</label>
            <input class="form-control {{ $errors->has('chif_aff_2') ? ' is-invalid' : '' }}" type="number" value="{{old('chif_aff_2')}}" name="chif_aff_2" min="0" maxlength="13" onkeypress="return isNumberKey(event)" placeholder="en DH" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Chiffre d'affaire - 3</label>
            <input class="form-control {{ $errors->has('chif_aff_3') ? ' is-invalid' : '' }}" type="number" value="{{old('chif_aff_3')}}" name="chif_aff_3" min="0"maxlength="13" onkeypress="return isNumberKey(event)" placeholder="en DH" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Chiffre d'affaire - 4</label>
            <input class="form-control {{ $errors->has('chif_aff_4') ? ' is-invalid' : '' }}" type="number" value="{{old('chif_aff_4')}}" name="chif_aff_4" min="0" maxlength="13" onkeypress="return isNumberKey(event)" placeholder="en DH" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Masse salarial</label>
            <input class="form-control {{ $errors->has('mass_salar') ? ' is-invalid' : '' }}" type="number" value="{{old('mass_salar')}}" name="mass_salar" min="0" maxlength="20" onkeypress="return isNumberKey(event)" placeholder="en DH" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Tax formation professionnel</label>
            <input class="form-control {{ $errors->has('tax_form_pers') ? ' is-invalid' : '' }}" value="{{old('tax_form_pers')}}" type="number" name="tax_form_pers" min="0" maxlength="13" onkeypress="return isNumberKey(event)" placeholder="en DH" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Dernière année CSF</label>
            <input class="form-control {{ $errors->has('der_annee_csf') ? ' is-invalid' : '' }}" value="{{old('der_annee_csf')}}" type="number" name="der_annee_csf" min="0" maxlength="4" onkeypress="return isNumberKey(event)" placeholder="une année" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Effectif</label>
            <input class="form-control {{ $errors->has('effectif') ? ' is-invalid' : '' }}" type="number" name="effectif" value="{{old('effectif')}}" min="0" maxlength="10" onkeypress="return isNumberKey(event)" placeholder="Effectif" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Nb. permanents</label>
            <input class="form-control {{ $errors->has('nb_permanent') ? ' is-invalid' : '' }}" type="number" value="{{old('nb_permanent')}}" name="nb_permanent" min="0" maxlength="10" onkeypress="return isNumberKey(event)" placeholder="nombre" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Nb. employés</label>
            <input class="form-control {{ $errors->has('nb_employe') ? ' is-invalid' : '' }}" type="number" value="{{old('nb_employe')}}" name="nb_employe" min="0" maxlength="10" onkeypress="return isNumberKey(event)" placeholder="nombre" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Nb. occasionnels</label>
            <input class="form-control {{ $errors->has('nb_occasional') ? ' is-invalid' : '' }}" type="number" value="{{old('nb_occasional')}}" name="nb_occasional" min="0" maxlength="10" onkeypress="return isNumberKey(event)" placeholder="nombre" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Nb. Ouvriers</label>
            <input class="form-control {{ $errors->has('nb_ouvrier') ? ' is-invalid' : '' }}" type="number" value="{{old('nb_ouvrier')}}" name="nb_ouvrier" min="0" maxlength="10" onkeypress="return isNumberKey(event)" placeholder="nombre" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Nb. Cadres</label>
            <input class="form-control {{ $errors->has('nb_cadre') ? ' is-invalid' : '' }}" type="number" value="{{old('nb_cadre')}}" name="nb_cadre" min="0" maxlength="10" onkeypress="return isNumberKey(event)" placeholder="nombre" >
        ...
        <div class="form-group col-lg-3 col-sm-12">
            ...
            <div class="form-group">
                <div class="custom-control custom-checkbox">
                    <input type="checkbox" name="IF1_1" id="IF1_1" class="custom-control-input" value="Réalisée">
        ...
        <div class="form-group col-lg-3 col-sm-12">
            ...
            <div class="form-group">
                <div class="custom-control custom-checkbox">
                    <input type="checkbox" name="IF2_1" id="IF2_1" class="custom-control-input" value="Réalisée">
        ...
        <div class="form-group col-lg-3 col-sm-12">
            ...
            <div class="form-group">
                <div class="custom-control custom-checkbox">
                    <input type="checkbox" name="IF3_1" id="IF3_1" class="custom-control-input" value="Réalisée">
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Année Missions 1</label>
            <input class="form-control {{ $errors->has('annee_deja1') ? ' is-invalid' : '' }}" type="number" value="{{old('annee_deja1')}}" name="annee_deja1" min="0" maxlength="4" onkeypress="return isNumberKey(event)" placeholder="année" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Année Missions 2</label>
            <input class="form-control {{ $errors->has('annee_deja2') ? ' is-invalid' : '' }}" type="number" value="{{old('annee_deja2')}}" name="annee_deja2" min="0" maxlength="4" onkeypress="return isNumberKey(event)" placeholder="année" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Année Missions 3</label>
            <input class="form-control {{ $errors->has('annee_deja3') ? ' is-invalid' : '' }}" type="number" value="{{old('annee_deja3')}}" name="annee_deja3" min="0" maxlength="4" onkeypress="return isNumberKey(event)" placeholder="année" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Tél. 1</label>
            <input class="form-control {{ $errors->has('tel_1') ? ' is-invalid' : '' }}" type="text" value="{{old('tel_1')}}" name="tel_1" min="0" maxlength="13" onkeypress="return isNumberKey(event)" placeholder="+(212)" >
            @if ($errors->has('tel_1'))
                <span class="invalid-feedback" role="alert">
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Tél. 2</label>
            <input class="form-control {{ $errors->has('tel_2') ? ' is-invalid' : '' }}" type="text" value="{{old('tel_2')}}" name="tel_2" min="0" maxlength="13" onkeypress="return isNumberKey(event)" placeholder="+(212)" >
            @if ($errors->has('tel_2'))
                <span class="invalid-feedback" role="alert">
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Fix 1</label>
            <input class="form-control {{ $errors->has('fix_1') ? ' is-invalid' : '' }}" type="text" value="{{old('fix_1')}}" name="fix_1" min="0" maxlength="13" onkeypress="return isNumberKey(event)" placeholder="+(212)" >
            @if ($errors->has('fix_1'))
                <span class="invalid-feedback" role="alert">
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Fix 2</label>
            <input class="form-control {{ $errors->has('fix_2') ? ' is-invalid' : '' }}" type="text" value="{{old('fix_2')}}" name="fix_2" min="0" maxlength="13" onkeypress="return isNumberKey(event)" placeholder="+(212)" >
            @if ($errors->has('fix_2'))
                <span class="invalid-feedback" role="alert">
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Fax 1</label>
            <input class="form-control {{ $errors->has('fax_1') ? ' is-invalid' : '' }}" type="text" value="{{old('fax_1')}}" name="fax_1" min="0" maxlength="13" onkeypress="return isNumberKey(event)" placeholder="+(212)" >
            @if ($errors->has('fax_1'))
                <span class="invalid-feedback" role="alert">
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Fax 2</label>
            <input class="form-control {{ $errors->has('fax_2') ? ' is-invalid' : '' }}" type="text" value="{{old('fax_2')}}" name="fax_2" min="0" maxlength="13" onkeypress="return isNumberKey(event)" placeholder="+(212)" >
            @if ($errors->has('fax_2'))
                <span class="invalid-feedback" role="alert">
        ...
        <div class="form-group col-lg-6 col-sm-12"><label>Site-Web</label>
            <input class="form-control {{ $errors->has('website') ? ' is-invalid' : '' }}" type="url" value="{{old('website')}}" name="website" placeholder="URL" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Nom DG 1</label>
            <input class="form-control {{ $errors->has('nom_dg1') ? ' is-invalid' : '' }}" type="text" value="{{old('nom_dg1')}}" name="nom_dg1" placeholder="nom" >
            @if ($errors->has('nb_cadre'))
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $errors->first('nb_cadre') }}</strong>
                </span>
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Fonction DG 1</label>
            <input class="form-control {{ $errors->has('fonct_dg1') ? ' is-invalid' : '' }}"type="text" value="{{old('fonct_dg1')}}" name="fonct_dg1" placeholder="fonction" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>GSM DG 1</label>
            <input class="form-control {{ $errors->has('gsm_dg1') ? ' is-invalid' : '' }}"type="text" value="{{old('gsm_dg1')}}" name="gsm_dg1" min="0" maxlength="13" onkeypress="return isNumberKey(event)" placeholder="+(212)" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Email DG 1</label>
            <input class="form-control {{ $errors->has('email_dg1') ? ' is-invalid' : '' }}" type="email" value="{{old('email_dg1')}}" name="email_dg1" placeholder="email" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Nom DG 2</label>
            <input class="form-control {{ $errors->has('nom_dg2') ? ' is-invalid' : '' }}" type="text" value="{{old('nom_dg2')}}" name="nom_dg2" placeholder="nom" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Fonction DG 2</label>
            <input class="form-control {{ $errors->has('fonct_dg2') ? ' is-invalid' : '' }}" type="text" value="{{old('fonct_dg2')}}" name="fonct_dg2" placeholder="fonction" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>GSM DG 2</label>
            <input class="form-control {{ $errors->has('gsm_dg2') ? ' is-invalid' : '' }}" type="text" value="{{old('gsm_dg2')}}" name="gsm_dg2" min="0" maxlength="13" onkeypress="return isNumberKey(event)" placeholder="+(212)" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Email DG 2</label>
            <input class="form-control {{ $errors->has('email_dg2') ? ' is-invalid' : '' }}"type="email" value="{{old('email_dg2')}}" name="email_dg2" placeholder="email" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Nom responsable</label>
            <input class="form-control {{ $errors->has('nom_resp') ? ' is-invalid' : '' }}" type="text" value="{{old('nom_resp')}}" name="nom_resp" placeholder="nom" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Fonction responsable</label>
            <input class="form-control {{ $errors->has('fonct_resp') ? ' is-invalid' : '' }}" type="text" value="{{old('fonct_resp')}}" name="fonct_resp" placeholder="fonction" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>GSM responsable</label>
            <input class="form-control {{ $errors->has('gsm_resp') ? ' is-invalid' : '' }}" type="text" value="{{old('gsm_resp')}}" name="gsm_resp" min="0" maxlength="20" onkeypress="return isNumberKey(event)" placeholder="+(212)" >
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>E-Mail responsable</label>
            <input class="form-control {{ $errors->has('email_resp') ? ' is-invalid' : '' }}" type="email" value="{{old('email_resp')}}" name="email_resp" placeholder="email" >
        ...
        <div class="form-group col-lg-6 col-sm-12"><label>RIB bancaire</label>
            <input class="form-control {{ $errors->has('rib') ? ' is-invalid' : '' }}" type="text" value="{{old('rib')}}" name="rib" min="0" maxlength="30" onkeypress="return isNumberKey(event)" placeholder="rib" >
            @if ($errors->has('rib'))
                <span class="invalid-feedback" role="alert">
        ...
        <div class="form-group col-lg-3 col-sm-12"><label>Agence bancaire</label>
            <input class="form-control {{ $errors->has('agence_banc') ? ' is-invalid' : '' }}"type="text" min="2" maxlength="20" value="{{old('agence_banc')}}" name="agence_banc" placeholder="agence" >
        ...
        <div class="form-group col-lg-4 col-sm-12"><label>Date relation</label>
            <input class="form-control {{ $errors->has('dt_relation') ? ' is-invalid' : '' }}" type="text" value="{{old('dt_relation')}}" name="dt_relation" onmouseover="(this.type='date')" id="date-more" placeholder="date" >
        ...
        {{-- <div class="form-group col-lg-3 col-sm-12"><label>TAG</label><input class="form-control {{ $errors->has('tag1') ? ' is-invalid' : '' }}" type="text" value="{{old('tag1')}}" name="tag1" min="0" maxlength="2" onkeypress="return isNumberKey(event)" placeholder="TAG" >
            @if ($errors->has('tag1'))
                <span class="invalid-feedback" role="alert">
    ...
    <div class="card-footer text-center">
        ...
        @endif
        <a class="btn bua2" href="/client"><i class="fas fa-window-close"></i>&nbsp;Annuler</a>
    </div>
