      ...
      <div class="container">
        ...
        >
          ...
          <span class="highlighted-danger" id="entrpDgNom">
            {{ curr_client_nom_dg1 || "(nom directeur entrp.)" }} </span
          ...
          >
            {{ curr_cabinet_raisoci || "(organisme)" }} </span
          >,
          ...
          <span class="highlighted-danger" id="cabinetCnss">
            {{ curr_cabinet_ncnss || "(CNSS organisme)" }} </span
          ...
          <tbody id="tableFormation" class="center" v-if="actions_by_ref">
            ...
            <tr v-for="(action, idx) in actions_by_ref" :key="`plan${idx}`">
              ...
              <td :id="action.n_form">
                ...
                De {{ action.dates && action.dates.date_debut }} à
                {{ action.dates && action.dates.date_fin }}
              </td>
              <td>
                {{ action.nb_jour }}
              </td>
