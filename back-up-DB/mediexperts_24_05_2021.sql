...
--
-- Hôte : 127.0.0.1:3307
-- Généré le : lun. 24 mai 2021 à 14:13
...
('171287', 'Mediexperts', 'SARL', 600000, '2007-09-28', 'Formation et ingénierie de formation', 'Analyse stratégique', 'Accompagnement et organisation des entreprises', '3 Data show+ 10 ordinateurs + Imprimante +Fax', '4 salles de formation', '12 cellulaires + lignes groupées', '1107015', '7612999', '35890500', 160, 1, 9, 50, 100, 10, 0, 20, 30, 0, 'non', 'Soufiane', 'Raid', 'GERANT', 'Belmokadem', 'Adil', 'Co-Gérant', '39, RUE AL FOURAT, 1er ETAGE, MAARIF, CASABLANCA', 'Casablanca', '0661680832', '0522991738', 'mediexperts@mediexperts.ma', 'https://mediexperts.ma', 'MediExperts est un cabinet de conseil en management des organisations.', '2020-07-24 05:28:19', '2021-04-06 10:57:31');
...
CREATE TABLE `clients` (
  ...
  `formjury` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dt_creat` date NOT NULL,
  `obj_soci` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `capt_soci` double(20,2) NOT NULL,
  `sect_activ` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
...
('103827', 'BURINTEL S.A', 'BURINTEL', '000027618000050', 'S.A', '2000-05-01', 'Distribution de Matériels Informatiques', 5000000.00, 'TECHNOLOGIE', 'Giac Technologies', '1087144', '6232483', '34770458', 87577950.00, 75632450.00, 68500000.00, 64670000.00, 28, 1122.00, 64452.00, 2020, 28, 19, 0, 0, 9, 'non réalisée', 'réalisée', 'réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', '2020', NULL, NULL, '0661908485', NULL, '0522254722', NULL, '0522254762', NULL, 'http://www.burintel.com/', '03 Rue Ibrahim Ibnou Adham Maarif, CASABLANCA.', 'Casablanca', 'Casablanca', 'NAWAL BENJELLOUN', 'Gérante', '0661908484', 'burintel@burintel.net', NULL, NULL, NULL, NULL, 'Nourdin EL HAJAMI', 'DIRECTEUR ADMINISTRATIF ET FINANCIER', '0661908485', 'n.elhajami@burintel.com', '0000', '0', NULL, NULL, NULL, '2019-01-01', NULL, '2020-10-21 13:12:02', '2021-04-28 15:25:00'),
('10963', 'Biscuiterie Moderne Zine', 'BMZ', '001878788000038', 'SARL', '2017-02-27', 'Biscuiterie industrielle', 10000000.00, 'Agro Alimentaire', 'GIAC AGROALIMENTAIRE', '20751280', '5249116', '9962', 45000000.00, 56000000.00, NULL, NULL, 107, 0.00, 0.00, 2020, 107, 51, 0, 43, 13, 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', NULL, NULL, NULL, '0660309339', NULL, '0522967777', NULL, '0522786092', NULL, 'http://www.zinecapitalinvest.ma/', 'Route principale 3011, zone industrielle Sahel Had Soualem', 'Had Soualem', 'Settat', 'Nourreddine ZINE', 'PRÉSIDENT DIRECTEUR GÉNÉRAL', '0660309339', 'm.baze@zinecapitalinvest.ma', NULL, NULL, NULL, NULL, 'Mounir BAZE', 'DRH', '0660309339', 'm.baze@zinecapitalinvest.ma', '0000001', 'a.remplr', NULL, NULL, NULL, '2019-01-01', NULL, '2020-10-23 09:47:01', '2021-04-06 10:00:49'),
('11111', 'TEST ENTREPRISE', 'VIVO', '54641641648', 'SARL', '2011-03-09', 'TECHNOLOGIES', 1000000000.00, 'TECHNOLOGIES', 'GIAC AGROALIMENTAIRE', '8419819841', '7576567', '76576766', 100000000.00, NULL, 100000000.00, 100000000.00, 50, 1000000.00, 10000.00, 2019, 20, 0, 10, 10, 10, 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', '2015', '2017', '2019', '+212611111111', '+212611111111', '+212611111999', '+212611111999', '+212611111777', '+212611111777', 'https://vivo.com', '6640 W Belden Ave, Elmwood Park, IL, 60707', '6640 W Belden Ave, Elmwood Park, IL, 60707', 'Fès', 'Ali Ahmed', 'PDG', '+212611111111', 'pdg@vivo.com', NULL, NULL, NULL, NULL, 'Ahmed Karim', 'Responsable', '+212611111111', 'pdg@vivo.com', '65739886368663811111', 'BMCI', 1000000.00, 500000.00, 1000000.00, '2019-11-04', 'EZAFR', '2020-07-24 06:38:57', '2021-04-06 09:31:00'),
('117713', 'TRANSDINE', 'TRSD', '001539780000043', 'SARL', '2002-02-13', 'Transport Logistique', 6000000.00, 'Transport et distribution', 'GIAC TRANSLOG', '2521378', '6562898', '31468528', 125112234.00, 114178143.00, 109913500.00, 0.00, 287, 0.00, 0.00, 2020, 287, 273, 0, 7, 7, 'réalisée', 'réalisée', 'réalisée', 'réalisée', 'non réalisée', 'réalisée', 'réalisée', 'non réalisée', 'réalisée', '2017', '2018', '2019', '0660309339', '0', '0522245268', '0', '0522245278', '0', 'https://zinecapitalinvest.ma', 'ROUTE PRINCIPALE 3011 ZONE INDUSTRIELLE Had Soualem', 'Had Soualem', 'Casablanca', 'Nourreddine ZINE', 'PRÉSIDENT DIRECTEUR GÉNÉRAL', '0660309339', 'm.baze@zinecapitalinvest.ma', NULL, NULL, '0', NULL, 'Mounir BAZE', 'DRH', '0660309339', 'm.baze@zinecapitalinvest.ma', '190780212119079000976', 'banque populaire', 0.00, 0.00, 0.00, '2017-02-01', NULL, '2020-09-18 09:40:48', '2021-04-06 10:46:32'),
...
('130757', 'DIVERSITY MEDIAS', 'DM', '002075165000073', 'SARL', '2018-05-04', 'MEDIA, PRESSE, PRODUCTION , AUDIOVISUELLE. CONSEIL EN STRATEGIE COMMUNICATION', 100000.00, 'Technologie', 'Giac Technologies', '25249362', '5916707', '25700522', 560000.00, 543415.00, 25500.00, 0.00, 20, NULL, 0.00, 2021, 20, 6, 0, 10, 4, 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', NULL, NULL, NULL, '0660406081', NULL, '0522236790', NULL, NULL, NULL, 'http://marayana.com/', '06, RUE DAYET AOUA 4EME ETAGE APPT 16 AGDAL,', 'RABAT', 'Rabat', 'SANAA EL AJI', 'GERANTE', '0660406081', 'selaji@gmail.com', NULL, NULL, NULL, NULL, 'SANAA EL AJI', 'GERANTE', '0660406081', 'selaji@gmail.com', '007780000128300000077553', 'AGENCE CASA SOCRATE', NULL, NULL, NULL, '2018-05-15', NULL, '2021-03-18 15:26:26', '2021-03-18 16:00:25'),
('13877', 'LES PEINTURES DU MIDI', 'MIDI P', '001534156000086', 'SA', '1986-11-04', 'Fabrication et commercialisation des peintures bâtiment', 2880000000.00, 'INDUSTRIE', 'GIAC 1', '5300513', '1204114', '10602360', 97708000.00, 103235000.00, 104152000.00, 113789000.00, 131, NULL, 182617.00, 2020, 131, 30, 0, 84, 17, 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', NULL, NULL, NULL, '0661 36 42 55', NULL, '0536 68 70 17', NULL, '0536 68 99 32', NULL, 'http://midipeinture.ma/', 'Zone Industrielle B.P. 334 Oujda', 'Oujda', 'Oujda', 'Kamal EL HARTI', 'Président Directeur Général', '0661364255', 'k.elharti@midipeinture.com', NULL, NULL, NULL, NULL, 'AABARI Khalid', 'RESPONSABLE RESSOURCES HUMAINES', '0661364255', 'k.aabari@midipeinture.com', '157570212111606563000075', 'BP CAF ISLY Oujda', NULL, NULL, NULL, '2017-04-25', NULL, '2021-04-23 14:53:50', '2021-04-23 14:53:50'),
('143199', 'CANAL FOOD', 'CF', '001539608000031', 'SARL', '2019-09-05', 'DISTRIBUTION', 32000000.00, 'DISTRIBUTION AGROALIMENTAIRE', 'GIAC AGROALIMENTAIRE', '2261026', '7063978', '32990189', 3000000.00, 2055000.00, 1975000.00, 0.00, 900, 0.00, 0.00, 2020, 900, 716, 0, 144, 40, 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', '2017', '2018', '2019', '0660309339', '0', '0522967777', '0', '0522964908', NULL, 'https:/www.zinecapitalinvest.ma', 'ZONE INDUSTRIELLE SAHEL ROUTE PRINCAPIALE 3011 HAD SOUALEM', 'HAD SOUALEM', 'Casablanca', 'Nourredine ZINE', 'PRÉSIDENT DIRECTEUR GÉNÉRAL', '0660309339', 'm.baze@zinecapitalinvest.ma', '0', '0', '0', 'a-remplir@test.com', 'Mounir BAZE', 'DRH', '0660309339', 'm.baze@zinecapitalinvest.ma', '190780212119006972000008', 'Banque Populaire', 0.00, 0.00, 0.00, '2017-02-01', NULL, '2020-09-17 11:23:20', '2021-04-06 10:09:58'),
('191003', 'OMNIYAT', 'OMNIYAT', '001537104000030', 'SARL', '2008-12-01', 'Ingénierie, intégration et Vente de logiciel (logistique et mobilité).', 100000.00, 'Technologie', 'Giac Technologies', '40270732', '7953773', '3633215', 227649046.00, 227751672.00, 164184551.00, 140468945.00, 12, NULL, 7410.00, 2021, 7, 4, 5, 5, 3, 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', NULL, NULL, NULL, '0661547007', NULL, '0522225409', NULL, '0522225409', NULL, 'http://www.omniyat.ma/', '131 Boulevard Abdelmoumen Casablanca', 'Casablanca', 'Casablanca', 'Saad BENNANI', 'Gérant', '0661547007', 'sb@omniyat.ma', NULL, NULL, NULL, NULL, 'Mourad EL HOUMIDI', 'Chef de projet', '0667533076', 'mourad@omniyat.ma', '013780	011740000490019648', 'BMCI Agence Californ', NULL, NULL, NULL, '2021-04-20', NULL, '2021-05-11 15:47:42', '2021-05-17 14:03:05'),
('193231', 'LES GRANDS MOULINS ZINE', 'LGMZ', '000196725000048', 'SARL', '2008-12-30', 'Agroalimentaire', 21000000.00, 'Mouture de blé tendre', 'GIAC AGROALIMENTAIRE', '40277608', '7961974', '32930803', 630000000.00, 604000000.00, 580000000.00, 0.00, 280, 0.00, 0.00, 2020, 280, 117, 0, 141, 22, 'réalisée', 'non réalisée', 'réalisée', 'réalisée', 'réalisée', 'réalisée', 'réalisée', 'non réalisée', 'réalisée', '2017', '2018', '2019', '0660309339', '0', '0522320107', NULL, '0522320178', '0', 'https://www.zinecapitalinvest.m', 'DAR LAGOUASSEM ROUTE BOUSKOURA CASABLANCA', 'Casablanca', 'Casablanca', 'Nourredine ZINE', 'PRÉSIDENT DIRECTEUR GÉNÉRAL', '0660309339', 'm.baze@zinecapitalinvest.ma', '0', '0', '0', NULL, 'Mounir BAZE', 'DRH', '0660309339', 'm.baze@zinecapitalinvest.ma', '190780212119556370001054', 'Banque Populaire', 0.00, 0.00, 0.00, '2017-02-01', NULL, '2020-09-18 06:40:09', '2021-04-06 10:13:11'),
('225725', 'MAGHREB COUTURE NEGOCE ET SERVICES \'\'MCNS\'\'', 'M.C.N.S', '000212897000001', 'SARL A.U', '2010-09-29', 'Confection habillement, import –export, négoce', 500000.00, 'TEXTILE', 'Giac textile et cuir', '40231001', '8567383', '34791319', NULL, 1064510.00, 1331539.00, 1193160.00, 25, NULL, 3281.00, 2021, 25, 8, 4, 11, 6, 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', NULL, NULL, NULL, '0663085225', NULL, '0522986148', NULL, '0522940001', NULL, 'http://www.mc-cotton.com/', '37, Rue Mekellil, Hay Raha, Casablanca', 'Casablanca', 'Casablanca', 'Abdelhay Mesfioui', 'Gérant', '0663085225', 'mesfioui2@hotmail.com', NULL, NULL, NULL, NULL, 'Abdelhay Mesfioui', 'Gérant', '0663085225', 'mesfioui2@hotmail.com', '190780212112408317000980', 'Banque Populaire', NULL, NULL, NULL, '2021-03-04', 'Nb. occasionnels : 4 / Nb. employés : 4 + occasionnels = 8', '2021-03-04 09:08:13', '2021-05-04 16:11:50'),
('22595', 'ALMOU TRANS', 'ALMOU', '000066202000062', 'SARL A.U', '2004-05-06', 'SERVICE DE TRANSIT EN DOUANES', 100000.00, 'TRANSPORT LOGISTIQUE', 'GIAC TRANSLOG', '4906905', '6774980', '50472816', 2699840.00, 3112498.00, 3138740.00, 2891167.00, 28, NULL, 18439.00, 2021, 21, 18, 0, 7, 3, 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', NULL, NULL, NULL, '0668 14 13 99', NULL, '0539 37 36 71', NULL, '0539 93 00 57', NULL, NULL, '7 Imm Al Waha B Av De La Résistance Etg 4 N°12 Tanger', 'TANGER', 'Tanger', 'Said KOUCH', 'GERANT', '0668 14 13 99', 'Said.kouch@yahoo.fr', NULL, NULL, NULL, NULL, 'Said KOUCH', 'GERANT', '0668 14 13 99', 'Said.kouch@yahoo.fr', '164 640 21211 7813265 0007  92', 'BP IBNOU BATOUTA', NULL, NULL, NULL, '2021-04-01', NULL, '2021-04-23 12:34:52', '2021-04-23 12:57:35'),
('230901', 'COMPAGNIE MAROCAINE DE MARBRE ET DE GRANITE', 'CMMG', '000222884000012', 'SARL', '2011-01-28', 'Importation et commercialisation des produits de marbre et granite', 2000000.00, 'INDUSTRIE', 'GIAC TRANSLOG', '40254789', '8595293', '37983395', 24684376.00, 23025256.00, 25771999.00, 19860211.00, 30, NULL, 19162.00, 2021, 27, 9, 3, 16, 5, 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', NULL, NULL, NULL, '0661933669', NULL, '0522581107', NULL, '0522584175', NULL, 'http://www.cmmg.ma/', 'Zone industrielle Sidi Mâarouf- Ouled Haddou-20190 Casablanca-Maroc', 'Casablanca', 'Casablanca', 'BERRADA SOUNNI Amina', 'GERANTE', '0661171812', 'contact@cmmg.ma', NULL, NULL, NULL, NULL, 'MAAMRI Yassine', 'DIRECTEUR ADMINISTRATIF ET FINANCIER', '0661933669', 'y.maamri@basmaholding.com', '13 780 01 007 00263900149 48', 'BMCI MAARIF ROUDANI', NULL, NULL, NULL, '2021-05-03', NULL, '2021-05-17 12:48:48', '2021-05-24 09:56:39'),
...
('254391', 'SA.GLOBAL', 'SGLOBAL', '000062689000047', 'S.A', '2012-02-28', 'INGENIERIE ET SYSTEMES D\'INFORMATIONS', 1000000.00, 'Technologie', 'Giac Technologies', '40469493', '9041740', '34792375', 24393259.00, NULL, 0.00, 0.00, 48, 0.00, 0.00, 2019, 48, 26, 0, 0, 22, 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', '2017', '2018', '2019', '0522445428', '0', '0522445428', '0', '0522443800', '0', 'https://www.saglobal.com/fr-ma/', '19 Rue Outba bnou ghazouane quartier palmier Casablanca', 'Casablanca', 'Casablanca', 'MOURAD JBIHA', 'DIRECTEUR GENERAL', '05 22 44 5428', 'mouradj@saglobal.com', '0', '00', '000', 'a-remplir@none.none', 'Nabila WARDI', 'Responsable RH', '0661425969', 'NabilaW@SAGlobal.com', '157570 2121116065630000 75', 'BP', 0.00, 0.00, 0.00, '2016-01-01', NULL, '2020-10-05 09:59:16', '2021-04-30 10:11:31'),
('28325', 'OKION', 'OKION', '000066562000042', 'SARL', '2016-06-01', 'informatique, bureautique, import-export de matériel informatique', 100000.00, 'Technologie', 'Giac Technologies', '4908511', '7231757', '50477844', 2432468349.00, 2816812986.00, 4284760847.00, 4775153206.00, 21, NULL, 7834.00, 2021, 16, 8, 5, 10, 3, 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', NULL, NULL, NULL, '0661 14 93 14', NULL, '0539 94 86 69', NULL, '0539 94 86 88', NULL, 'http://google.ma/', '89, AVENUE MOUSSA IBN NOUSSAIR APPT. N° 78. 5 EME ETAGE 90010 TANGER', 'TANGER', 'Tanger', 'Nihad MALLA HUSSEIN', 'PRESIDENT DIRECTEUR GENERAL', '0661 14 93 14', 'nihad.malla@maroc-toner.com', NULL, NULL, NULL, NULL, 'Nihad MALLA HUSSEIN', 'PRESIDENT DIRECTEUR GENERAL', '0661 14 93 14', 'nihad.malla@maroc-toner.com', '022640000104000504414221', 'TANGER IBN TOUMERT', NULL, NULL, NULL, '2021-04-25', NULL, '2021-05-11 16:36:38', '2021-05-17 15:53:08'),
('286479', 'LES GRANDES SEMOULERIES ZINE', 'LGSZ', '000032849000045', 'SARL', '2013-08-07', 'Minoterie', 10000000.00, 'Agroalimentaire', 'GIAC AGROALIMENTAIRE', '14448724', '9174989', '32020385', 340000000.00, 307000000.00, 295000000.00, 0.00, 108, 0.00, 107068.00, 2020, 108, 40, 0, 54, 14, 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', '2017', '2018', '2019', '0660309339', NULL, '0522334148', NULL, '0522592513', '0', 'http://www.zinecapitalinvest.ma/fr/', 'Zone industrielle Ouled Saleh-Bouskoura', 'Bouskoura', 'Settat', 'Nourredine ZINE', 'PRÉSIDENT DIRECTEUR GÉNÉRAL', '0660309339', 'm.baze@zinecapitalinvest.ma', NULL, NULL, NULL, 'contact@zinecapitalinvest.ma', 'BAZE MOUNIR', 'DIRECTEUR RH', '0660309339', 'm.baze@zinecapitalinvest.ma', '190780212118884958000945', 'Banque Populaire', 0.00, 0.00, 0.00, '2017-01-01', NULL, '2020-09-17 06:42:38', '2021-04-06 10:20:17'),
...
('328729', 'ZINE CAPITAL INVEST', 'ZCI', '001606285000072', 'SA', '2015-06-08', 'Valeurs mobilières', 405000000.00, 'Gestion des valeurs mobilieres', 'Giac tertiaire', '15260781', '4302618', '36167345', 16300000.00, 15912459.00, 15300000.00, 0.00, 25, 0.00, 0.00, 2020, 25, 0, 0, 0, 25, 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', '2017', '2018', '2019', '0660309339', NULL, '0522786089', '0', '0522786092', '0', 'https://www.zinecapitalinvestt.ma', 'Lotissement la Colline II n°10 .Sidi Maarouf. CASABLANCA', 'CASABLANCA', 'Casablanca', 'Nourredine ZINE', 'PRÉSIDENT DIRECTEUR GÉNÉRAL', '0660309339', 'm.baze@zinecapitalinvest.ma', NULL, NULL, NULL, NULL, 'Mounir BAZE', 'DRH', '0660309339', 'm.baze@zinecapitalinvest.ma', '190780212111314355000387', 'Banque populaire', 0.00, 0.00, 0.00, '2017-01-30', NULL, '2020-09-18 10:59:48', '2021-04-06 08:42:25'),
('32891', 'MAROC FER', 'M FER', '001531693000045', 'SARL', '1975-01-02', 'CONSTRUCTIONS MÉTALLIQUES', 80000000.00, 'INDUSTRIE', 'GIAC 1', '1084438', '1572355', '36101421', 621697304.00, 606379753.00, 470660110.00, 358435095.00, 120, NULL, 87832.00, 2021, 112, 50, 8, 49, 21, 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', NULL, NULL, NULL, '0661933669', NULL, '0522335844', NULL, '0522321150', NULL, 'http://www.marocfer.com/', 'Zone industrielle Sidi Mâarouf- Ouled Haddou-20190 Casablanca-Maroc', 'Casablanca', 'Casablanca', 'BERRADA SOUNNI Mehdi', 'GERANT', '0661137262', 'bsm@marocfer.com', NULL, NULL, NULL, NULL, 'MAAMRI Yassine', 'DIRECTEUR ADMINISTRATIF ET FINANCIER', '0661933669', 'y.maamri@basmaholding.com', '007 780 0003408000000069 82', 'C D’AFFAI MANDARONA', NULL, NULL, NULL, '2021-05-03', NULL, '2021-05-17 13:19:55', '2021-05-17 13:19:55'),
('376161', 'SALES UPLIFT', 'Uplift', '001923722000096', 'SARL', '2017-07-01', 'Logistique et distribution', 500000.00, 'Logistique et transport', 'GIAC TRANSLOG', '20775319', '5483756', '36397176', 60335391.00, 31877262.00, 0.00, 0.00, 72, 0.00, 45866.00, 2020, 53, 29, 19, 33, 10, 'réalisée', 'non réalisée', 'réalisée', 'réalisée', 'non réalisée', 'réalisée', 'non réalisée', 'non réalisée', 'non réalisée', '2019', '2020', '0', '0614905110', '0', '0522583763', '0', '0522976742', '0', 'https://salesuplift.ma', 'N11, Immeuble E, Résidence Al Ahfad, Etage 3, Boulevard Abou Bakr El Kadiri Sidi Maarouf, Casablanca', 'Casablanca', 'Casablanca', 'Adil RAISS EL FENNI', 'Directeur Général', '0614905110', 'adil.raiss@sales-uplift.com', '0', '0', '0', NULL, 'Adil RAISS EL FENNI', 'Directeur Général', '0614905110', 'adil.raiss@sales-uplift.com', '0', '0', 0.00, 0.00, 0.00, '2019-10-01', NULL, '2020-09-23 04:25:42', '2021-05-17 14:55:11'),
...
('38715', 'NEW PEPPERS', 'NEWPEP', '001536137000046', 'SARL', '2012-05-15', 'Conditionnement des produits agricoles.', 2500000.00, 'AGROALIMENTAIRE', 'GIAC AGROALIMENTAIRE', '40493269', '9144271', '13600108', 20799897.00, 26176985.00, 24719035.00, NULL, 43, NULL, 4176.00, 2021, 13, 4, 0, 33, 6, 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', NULL, NULL, NULL, '0661160663', NULL, '0535641715', NULL, NULL, NULL, 'https://www.peppafrica.com/', 'BUR 41 ESPACE RIAD FES RUE LALLA AICHA CHAMPS DE COURSES – FES -', 'Fès', 'Fès', 'EL MEHDI BENNOUNA', 'Directeur général', '0661160663', 'bennouna.esigmaroc@gmail.com', NULL, NULL, NULL, NULL, 'EL MEHDI BENNOUNA', 'Directeur général', '0661160663', 'bennouna.esigmaroc@gmail.com', '011270000001210001633321', 'BMCE CA. FES', NULL, NULL, NULL, '2016-01-16', NULL, '2021-03-30 14:49:03', '2021-05-05 11:58:36'),
...
('5587', 'ZINE CEREALES', 'ZC', '001552391000016', 'SARL', '2011-01-07', 'Négoce de céréales, aliments de bétail et engrais', 70000000.00, 'AGROALIMENTAIRE', 'GIAC AGROALIMENTAIRE', '40240148', '8407050', '55710217', 1630000.00, 1593000.00, 0.00, 0.00, 190, 0.00, 0.00, 2020, 190, 103, 0, 73, 14, 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', '2017', '2018', '2019', '0660309339', '0', '0522963434', '0', '0522963435', '0', 'https://www.zinecapitalinvest.ma', 'Zone Industrielle Route Principale 3011 Had Soualem', 'Had Soualem', 'Settat', 'Nourredine ZINE', 'PRÉSIDENT DIRECTEUR GÉNÉRAL', '0660309339', 'm.baze@zinecapitalinvest.ma', NULL, NULL, NULL, NULL, 'Mounir BAZE', 'DRH', '0660309339', 'm.baze@zinecapitalinvest.ma', '190780212112641760000788', 'Banque Populaire', 0.00, 0.00, 0.00, '2017-02-01', NULL, '2020-09-17 10:17:32', '2021-04-06 10:36:39'),
('7077', 'COMPLEXE ALIMENTAIRE ZINE', 'CALZ', '000031691000077', 'SARL', '2013-02-13', 'FABRICATION ET CONDITIONNEMENT DE PATES ET COUSCOUS', 10000000.00, 'AGROALIMENTAIRE', 'GIAC AGROALIMENTAIRE', '14407420', '9174806', '55710221', 190000000.00, 179000000.00, 172000000.00, 0.00, 120, 0.00, 101421.00, 2020, 120, 59, 0, 51, 10, 'réalisée', 'réalisée', 'réalisée', 'réalisée', 'non réalisée', 'réalisée', 'réalisée', 'non réalisée', 'réalisée', '2017', '2018', '2019', '0660309339', NULL, '0522963689', NULL, '0522963684', NULL, 'http://www.zinecapitalinvest.ma', 'ZONE INDUSTRIELLE SAHEL ROUTE PRINCAPIALE 3011 HAD SOUALEM', 'Had Soualem', 'Settat', 'Nourreddine ZINE', 'PRESIDENT DIRECTEUR GENERAL', '0660309339', 'm.baze@zinecapitalinvest.ma', '--', '--', '0', NULL, 'Mounir BAZE', 'DIRECTEUR RH', '0660309339', 'm.baze@zinecapitalinvest.ma', '011780000029210000074301', 'BMCE', 120000.00, 100000.00, 200000.00, '2017-01-01', NULL, '2020-08-04 05:26:34', '2021-04-06 10:55:22'),
('77267', 'SMART WORKS', 'SW', '001795907000035', 'SARL', '2016-10-17', 'Fabrication et commercialisation de Matériels Roulants', 3500000.00, 'INDUSTRIE AUTOMOBILE', 'GIAC 1', '20693485', '5198751', '46200171', 16000000.00, 40000000.00, 44370000.00, 47640000.00, 53, NULL, 9582.00, 2021, 44, 19, 9, 25, 9, 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', NULL, NULL, NULL, '0661209954', NULL, '0528521618', NULL, '0528521306', NULL, 'http://www.smartworksmaroc.com/', 'Bureau N° 05, Avenue Hassan 2, Résidence Fajwa, Immeuble B Au 1er Étage – 40000 Ménara, Marrakech', 'MARRAKECH', 'Marrakech', 'ABDERRAHMANE ELMAHFOUDI', 'GERANT', '0661420297', 'abdouaiman@gmail.com', NULL, NULL, NULL, NULL, 'Ibrahima Mamadou TALL', 'CHARGE DE MISSION', '0661209954', 'tallsotineq@gmail.com', '011 450 000 003 210 000 663691', 'BMCE BANK OF AFRICA', NULL, NULL, NULL, '2021-03-12', NULL, '2021-03-12 09:05:46', '2021-03-31 13:14:44'),
('89005', 'KOSMOPHARM', 'KPH', '000094349000088', 'SA', '1997-07-02', 'Fabrication de médicaments, compléments alimentaires et produits cosmétiques', 25800000.00, 'NDUSTRIE PHARMACEUTIQUE, PARAPHARMACEUTIQUE', 'GIAC 1', '2201250', '6065470', '36102647', NULL, 22769000.00, 24952000.00, 23769000.00, 54, NULL, 91152.00, 2021, 54, 32, 1, 16, 6, 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', NULL, NULL, NULL, '0661041950', NULL, '0522335893', NULL, '0522335893', NULL, 'http://www.kosmopharm.com/', '272 LOT LINA ZI SIDI MAAROUF CASABLANCA', 'CASABLANCA', 'Casablanca', 'KERDOUDI KOLALI SIDI AZZEDDINE', 'Président Directeur Général', '0661138135', 'a.kerdoudi@kosmopharm.com', NULL, NULL, NULL, NULL, 'SANAE BADRI', 'DAF', '0661041950', 'fianance@kosmopharm.com', '0022 780 0000430005165471 74', 'SGMB', NULL, NULL, NULL, '2021-01-05', NULL, '2021-03-12 09:20:06', '2021-03-12 13:42:50'),
('91175', 'LEADER FOOD', 'LDF', '000013334000046', 'S.A', '1999-06-01', 'Fabrication  des chips, Mais et Snacks', 14920000.00, 'Agroalimentaire', 'GIAC AGROALIMENTAIRE', '1900841', '6091160', '30650802', 176000000.00, 161000000.00, 130000000.00, 126000000.00, 317, NULL, 236315.00, 2020, 317, 110, 185, 200, 7, 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', 'non réalisée', NULL, NULL, NULL, '0661832879', NULL, '0522344442', NULL, '0522344445', NULL, 'http://www.leader-food.com/', 'BD CHEFCHAOUINI RUE SB 7 QUARTIER INDUSTRIEL, SIDI BERNOUSSI', 'Casablanca', 'Casablanca', 'LARAKI HOSSEIN', 'DIRECTEUR GENERAL', '0661324403', 'h.laraki@leader-food.com', NULL, NULL, NULL, NULL, 'Ahmed BOUDRAA', 'DAF', '0661832879', 'a.boudraa@leader-food.com', '007780000540100000154448', 'AWB', NULL, NULL, NULL, '2018-01-01', 'Nb. occasionnels : 185 déjà  reparties', '2020-11-02 07:39:43', '2021-05-05 12:10:57');
...
CREATE TABLE `demande_financements` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `prc_cote_part_demande` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `n_contrat` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `n_facture` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(5, 'préparé', 'diagnostic stratégique', 2020, 'Giac textile et cuir', 3, '2019-12-24', 20, 120000, 'giac', 'non préparé', 'non préparé', 'giac', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'non préparé', 'non préparé', 'non préparé', 'giac', 'non préparé', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'préparé', '2020-03-12', 'non préparé', 'giac', 'giac', 'giac', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', '2020-03-12', 'préparé', '2020-03-02', 'giac', 'non préparé', '2020-03-12', '2020-02-24', '2020-02-28', 10, 25000, '30%', 50000, 'SOIXANTE MILLE', 'préparé', 'non préparé', '2020-02-21', 'préparé', 'non préparé', 'préparé', '2020-10-12', 'préparé', '2020-10-19', 'préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'préparé', '2020-10-16', NULL, 'approuvé', '45307', '2020-11-16 14:40:17', '2020-12-04 08:03:50', NULL, '', NULL, NULL),
(6, 'préparé', 'ingénierie de formation', 2020, 'Giac textile et cuir', 3, '2020-10-16', 16, 96000, 'giac', 'non préparé', 'non préparé', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', 'non préparé', 'non préparé', 'non préparé', 'giac', 'giac', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'préparé', '2020-03-12', '0000', 'giac', 'giac', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', '2020-10-16', 'préparé', '2020-10-19', 'non préparé', 'giac', '2020-10-23', '2020-10-20', '2020-10-22', 8, 19200, '20%', 48000, 'CINQUANTE-SEPT MILLE SIX CENTS', 'non préparé', 'préparé', '2020-10-19', 'non préparé', 'préparé', 'préparé', '2020-10-23', 'préparé', '2020-10-27', 'non préparé', 'préparé', 'non préparé', 'non préparé', 'préparé', 'préparé', 'préparé', '2020-10-23', NULL, 'approuvé', '45307', '2020-11-17 08:36:20', '2021-02-24 14:35:49', '20%', '', NULL, NULL),
(7, 'préparé', 'diagnostic stratégique', 2020, 'Giac tertiaire', 3, '2020-11-04', 17, 119000, 'giac', 'non préparé', 'non préparé', 'giac', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'non préparé', 'non préparé', 'non préparé', 'giac', 'non préparé', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'préparé', '2020-11-04', 'non préparé', 'giac', 'giac', 'giac', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', '2020-09-24', 'préparé', '2020-09-30', 'giac', 'non préparé', '2020-10-23', '2020-10-05', '2020-10-10', 12, 33000, '30%', 66000, 'SOIXANTE-DIX-NEUF MILLE DEUX CENTS', 'préparé', 'non préparé', '2020-10-20', 'préparé', 'non préparé', 'non préparé', NULL, 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, NULL, 'accordé', '251529', '2020-11-17 08:41:19', '2021-01-28 13:22:49', NULL, '', NULL, NULL),
(8, 'préparé', 'ingénierie de formation', 2020, 'Giac tertiaire', 3, '2020-11-04', 17, 99000, 'giac', 'non préparé', 'giac', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', 'non préparé', 'non préparé', 'non préparé', 'giac', 'giac', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'préparé', '2020-11-04', 'non préparé', 'giac', 'giac', 'giac', 'giac', 'non préparé', 'non préparé', 'non préparé', 'giac', 'giac', '2020-09-24', 'préparé', '2020-09-30', 'non préparé', 'giac', '2020-11-12', '2020-10-12', '2020-10-15', 11, 30250, '30%', 60500, 'SOIXANTE-DOUZE MILLE SIX CENTS', 'non préparé', 'préparé', '2020-10-20', 'non préparé', 'préparé', 'préparé', '2020-10-23', 'préparé', '2020-10-23', 'non préparé', 'préparé', 'non préparé', 'non préparé', 'préparé', 'préparé', 'préparé', '2020-10-23', NULL, 'approuvé', '251529', '2020-11-17 09:14:46', '2021-01-28 13:23:43', NULL, '', NULL, NULL),
(9, 'préparé', 'ingénierie de formation', 2020, 'GIAC BTP', 5, '2020-10-09', 16, 96000, 'giac', 'non préparé', 'non préparé', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', 'non préparé', 'préparé', 'préparé', 'giac', 'giac', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'préparé', '2020-03-05', '98767,9', 'giac', 'giac', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', '2020-10-09', 'préparé', '2020-10-16', 'non préparé', 'cabinet', '2020-11-25', '2020-10-19', '2020-10-21', 14, 35000, '30%', 70000, 'QUATRE-VINGT-QUATRE MILLE', 'non préparé', 'préparé', '2020-10-23', 'non préparé', 'préparé', 'préparé', '2020-10-23', 'préparé', '2020-10-26', 'non préparé', 'préparé', 'non préparé', 'non préparé', 'préparé', 'préparé', 'préparé', '2020-10-23', NULL, 'approuvé', '296871', '2020-11-17 09:59:02', '2021-01-28 13:59:16', NULL, '', NULL, NULL),
(10, 'préparé', 'ingénierie de formation', 2020, 'GIAC TRANSLOG', 3, '2020-09-16', 17, 99000, 'giac', 'non préparé', 'non préparé', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', 'non préparé', 'non préparé', 'préparé', 'giac', 'giac', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'préparé', '2020-09-16', 'non préparé', 'giac', 'giac', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', '2020-10-09', 'préparé', '2020-10-08', 'non préparé', 'giac', '2020-11-11', '2020-10-10', '2020-10-12', 8, 24000, '30%', 48000, 'CINQUANTE-SEPT MILLE SIX CENTS', 'non préparé', 'préparé', '2020-10-26', 'non préparé', 'préparé', 'préparé', '2020-10-26', 'préparé', '2020-10-28', 'non préparé', 'préparé', 'non préparé', 'non préparé', 'préparé', 'préparé', 'préparé', '2020-10-26', NULL, 'approuvé', '376161', '2020-11-17 10:59:15', '2020-12-03 07:45:15', NULL, '', NULL, NULL),
(11, 'préparé', 'ingénierie de formation', 2020, 'GIAC AGROALIMENTAIRE', 4, '2020-05-29', 20, 120000, 'giac', 'non préparé', 'giac', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', 'non préparé', 'non préparé', 'préparé', 'giac', 'giac', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'préparé', '2020-05-29', '200000', 'giac', 'giac', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', '2020-10-26', 'préparé', '2020-09-08', 'non préparé', 'giac', '2020-10-26', '2020-09-14', '2020-09-17', 16, 40000, '30%', 80000, 'QUATRE-VINGT-SEIZE MILLE', 'non préparé', 'préparé', '2020-10-26', 'non préparé', 'préparé', 'préparé', '2020-10-26', 'préparé', '2020-10-27', 'non préparé', 'préparé', 'non préparé', 'préparé', 'préparé', 'préparé', 'préparé', '2020-10-26', 'A récupérer contrats auprès du GIAC', 'approuvé', '7077', '2020-11-17 12:18:40', '2020-12-03 08:55:35', NULL, '', NULL, NULL),
(12, 'préparé', 'ingénierie de formation', 2020, 'GIAC AGROALIMENTAIRE', 5, '2020-05-29', 20, 120000, 'giac', 'non préparé', 'giac', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', 'non préparé', 'non préparé', 'préparé', 'giac', 'giac', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'préparé', '2020-05-29', '200000', 'giac', 'non préparé', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', '2020-10-26', 'préparé', '2020-09-08', 'non préparé', 'giac', '2020-10-26', '2020-09-14', '2020-09-16', 15, 37500, '30%', 75000, 'QUATRE-VINGT-DIX MILLE', 'non préparé', 'préparé', '2020-10-26', 'non préparé', 'préparé', 'préparé', '2020-10-26', 'préparé', '2020-10-27', 'non préparé', 'préparé', 'non préparé', 'préparé', 'préparé', 'préparé', 'préparé', '2020-10-26', 'A récupérer contrat auprès du GIAC', 'approuvé', '286479', '2020-11-17 12:42:19', '2020-12-03 08:58:03', NULL, '', NULL, NULL),
(13, 'préparé', 'ingénierie de formation', 2020, 'GIAC AGROALIMENTAIRE', 5, '2020-05-29', 20, 120000, 'giac', 'non préparé', 'giac', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', 'non préparé', 'non préparé', 'préparé', 'giac', 'giac', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'préparé', '2020-05-29', '200000', 'giac', 'non préparé', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', '2020-10-26', 'préparé', '2020-09-08', 'non préparé', 'giac', '2020-10-26', '2020-09-20', '2020-09-24', 16, 40000, '30%', 80000, 'QUATRE-VINGT-SEIZE MILLE', 'non préparé', 'préparé', '2020-10-26', 'non préparé', 'préparé', 'préparé', '2020-10-26', 'préparé', '2020-10-27', 'non préparé', 'préparé', 'non préparé', 'préparé', 'préparé', 'préparé', 'préparé', '2020-10-26', 'A récupérer contrat auprès du GIAC', 'approuvé', '5587', '2020-11-17 13:04:25', '2020-12-03 09:23:20', NULL, '', NULL, NULL),
(14, 'préparé', 'ingénierie de formation', 2020, 'GIAC AGROALIMENTAIRE', 3, '2020-05-19', 20, 120000, 'giac', 'non préparé', 'giac', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', 'non préparé', 'préparé', 'préparé', 'giac', 'giac', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'préparé', '2020-05-19', '259946,73', 'giac', 'non préparé', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', '2020-10-26', 'non préparé', '2020-09-08', 'non préparé', 'giac', '2020-10-26', '2020-09-20', '2020-09-24', 16, 40000, '30%', 80000, 'QUATRE-VINGT-SEIZE MILLE', 'non préparé', 'préparé', '2020-10-26', 'non préparé', 'préparé', 'préparé', '2020-10-26', 'préparé', '2020-10-27', 'non préparé', 'préparé', 'non préparé', 'préparé', 'préparé', 'préparé', 'préparé', '2020-10-26', 'A récupérer contrats auprès du GIAC', 'approuvé', '193231', '2020-11-17 13:45:57', '2020-12-03 09:02:51', NULL, '', NULL, NULL),
(15, 'préparé', 'ingénierie de formation', 2020, 'GIAC TRANSLOG', 4, '2020-05-19', 16, 96000, 'giac', 'non préparé', 'non préparé', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', 'non préparé', 'préparé', 'préparé', 'giac', 'giac', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'préparé', '2020-05-19', '337973,93', 'giac', 'non préparé', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', '2020-07-23', 'préparé', '2020-10-08', 'non préparé', 'giac', '2020-10-19', '2020-10-12', '2020-10-14', 12, 28800, '20%', 72000, 'QUATRE-VINGT-SIX MILLE QUATRE CENTS', 'non préparé', 'préparé', '2020-10-26', 'non préparé', 'préparé', 'préparé', '2020-10-26', 'préparé', '2020-11-02', 'non préparé', 'préparé', 'non préparé', 'non préparé', 'préparé', 'préparé', 'préparé', '2020-10-26', NULL, 'approuvé', '117713', '2020-11-17 13:55:43', '2020-12-03 09:11:25', NULL, '', NULL, NULL),
(16, 'préparé', 'ingénierie de formation', 2020, 'GIAC AGROALIMENTAIRE', 5, '2020-05-19', 20, 120000, 'giac', 'non préparé', 'giac', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', 'non préparé', 'préparé', 'préparé', 'giac', 'giac', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'préparé', '2020-05-19', '840875,66', 'giac', 'giac', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', '2020-10-26', 'non préparé', '2020-09-08', 'non préparé', 'giac', '2020-10-26', '2020-09-14', '2020-09-18', 18, 36000, '20%', 90000, 'CENT HUIT MILLE', 'non préparé', 'préparé', '2020-10-26', 'non préparé', 'préparé', 'préparé', '2020-10-26', 'préparé', '2020-10-27', 'non préparé', 'préparé', 'non préparé', 'préparé', 'préparé', 'préparé', 'préparé', '2020-10-26', 'A récupérer contrats auprès du giac', 'approuvé', '143199', '2020-11-17 14:09:01', '2020-12-03 09:31:01', NULL, '', NULL, NULL),
(17, 'préparé', 'diagnostic stratégique', 2020, 'GIAC AGROALIMENTAIRE', 3, '2020-05-29', 20, 120000, 'giac', 'giac', 'non préparé', 'giac', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'non préparé', 'non préparé', 'non préparé', 'giac', 'giac', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'préparé', '2020-05-29', NULL, 'giac', 'non préparé', 'giac', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', '2020-10-26', 'non préparé', '2020-09-08', 'giac', 'non préparé', '2020-10-26', '2020-09-25', '2020-10-03', 20, 60000, '30%', 120000, 'CENT QUARANTE-QUATRE MILLE', 'préparé', 'non préparé', '2020-10-26', 'préparé', 'non préparé', 'non préparé', NULL, 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, '- A élaborer rapport \r\n- A récupérer contrats auprès du GIAC', 'accordé', '10963', '2020-11-17 14:23:19', '2020-12-03 08:33:06', NULL, '', NULL, NULL),
(18, 'préparé', 'ingénierie de formation', 2020, 'GIAC AGROALIMENTAIRE', 5, '2020-05-29', 20, 120000, 'giac', 'non préparé', 'giac', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', 'non préparé', 'non préparé', 'non préparé', 'giac', 'giac', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'préparé', '2020-05-29', '300000', 'giac', 'non préparé', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', '2020-10-26', 'non préparé', '2020-09-08', 'non préparé', 'giac', '2020-10-26', '2020-09-28', '2020-10-02', 20, 40000, '20%', 100000, 'CENT VINGT MILLE', 'non préparé', 'préparé', '2020-10-26', 'non préparé', 'préparé', 'préparé', '2020-10-26', 'préparé', '2020-10-27', 'non préparé', 'préparé', 'non préparé', 'préparé', 'préparé', 'préparé', 'préparé', '2020-10-26', 'contrats signé et déposé , à récupérer auprès du giac', 'approuvé', '10963', '2020-12-03 08:28:18', '2020-12-03 08:52:29', NULL, '', NULL, NULL),
(20, 'préparé', 'diagnostic stratégique', 2021, 'GIAC 1', 4, '2021-02-08', 20, 140000, 'giac', 'non préparé', 'non préparé', 'client', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'non préparé', 'non préparé', 'non préparé', 'giac', 'giac', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'préparé', '2021-01-19', NULL, 'cabinet', 'giac', 'giac', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', '2021-02-10', 'préparé', '2021-03-04', 'giac', 'non préparé', '2021-04-02', '2021-04-19', '2021-04-23', 10, 25000, '30%', 50000, 'SOIXANTE MILLE', 'préparé', 'non préparé', '2021-04-09', 'préparé', 'non préparé', 'non préparé', NULL, 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, 'demande de recours pour augmentation du budget accordé/ REJET', 'accordé', '126089', '2021-01-19 14:19:45', '2021-04-19 10:56:13', '30%', '12/2021', '01-2021', '2021-02-08'),
(21, 'préparé', 'ingénierie de formation', 2021, 'GIAC 1', 4, '2021-02-09', 17, 102000, 'giac', 'non préparé', 'non préparé', 'giac', 'client', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', 'non préparé', 'non préparé', 'non préparé', 'giac', 'giac', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'préparé', '2021-01-19', '300000', 'cabinet', 'giac', 'giac', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', '2021-02-10', 'préparé', '2021-03-04', 'non préparé', 'giac', '2021-04-02', NULL, NULL, 10, 20000, '20%', 50000, 'SOIXANTE MILLE', 'non préparé', 'préparé', '2021-04-16', 'non préparé', 'préparé', 'non préparé', NULL, 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, 'Demande de recours pour augmentation du budget accordé : déposée le 08/03/2021', 'accordé', '126089', '2021-01-19 14:54:30', '2021-04-19 10:55:19', '20%', '10/2021', '02-2021', '2021-02-08'),
(22, 'préparé', 'ingénierie de formation', 2021, 'GIAC AGROALIMENTAIRE', 4, '2021-01-19', 20, 100000, 'cabinet', 'non préparé', 'cabinet', 'non préparé', 'cabinet', 'non préparé', 'cabinet', 'non préparé', 'cabinet', 'cabinet', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'cabinet', 'ofppt', 'ofppt', 'non préparé', 'ofppt', 'ofppt', 'ofppt', 'préparé', '2021-03-17', '179276', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-03-17', 'non préparé', '2021-03-22', 'non préparé', 'client', NULL, NULL, NULL, 8, 20000, '30%', 40000, 'QUARANTE-HUIT MILLE', 'non préparé', 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', NULL, 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, NULL, 'accordé', '38419', '2021-03-17 15:34:15', '2021-05-05 10:09:25', '30%', 'DF21/040', '05-2021', '2021-01-19'),
(23, 'préparé', 'diagnostic stratégique', 2021, 'GIAC AGROALIMENTAIRE', 4, '2021-01-12', 17, 119000, 'cabinet', 'cabinet', 'non préparé', 'non préparé', 'cabinet', 'cabinet', 'non préparé', 'cabinet', 'non préparé', 'cabinet', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'cabinet', 'ofppt', 'ofppt', 'cabinet', 'ofppt', 'ofppt', 'ofppt', 'préparé', '2021-02-18', NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-02-02', 'non préparé', '2021-02-09', 'client', 'non préparé', NULL, NULL, NULL, 6, 15000, '30%', 30000, 'TRENTE-SIX MILLE', 'non préparé', 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', NULL, 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, 'Dossier physique DF à déposer', 'accordé', '38715', '2021-03-30 15:35:20', '2021-05-05 10:09:37', '30%', 'DF21/003', '03-2021', '2021-01-12'),
(24, 'préparé', 'ingénierie de formation', 2021, 'GIAC AGROALIMENTAIRE', 4, '2021-01-12', 17, 102000, 'cabinet', 'non préparé', 'cabinet', 'non préparé', 'cabinet', 'non préparé', 'cabinet', 'non préparé', 'cabinet', 'cabinet', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'cabinet', 'ofppt', 'ofppt', 'cabinet', 'ofppt', 'ofppt', 'ofppt', 'préparé', '2021-02-18', '62642', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-02-02', 'non préparé', '2021-02-09', 'non préparé', 'cabinet', NULL, NULL, NULL, 3, 6000, '20%', 15000, 'DIX-HUIT MILLE', 'non préparé', 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', NULL, 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, NULL, 'accordé', '38715', '2021-03-30 15:58:12', '2021-05-05 10:10:13', '20%', 'DF21/004', '04-2021', '2021-01-12'),
(25, 'Préparé', 'Ingénierie de formation', 2021, 'GIAC AGROALIMENTAIRE', 4, '2021-03-01', 20, 120000, 'client', 'non préparé', 'client', 'client', 'client', 'non préparé', 'client', 'non préparé', 'client', 'client', 'non préparé', 'non préparé', 'non préparé', 'client', 'client', 'client', 'client', 'client', 'client', 'client', 'client', 'non préparé', NULL, '236315', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-03-24', 'non préparé', '2021-04-13', 'non préparé', 'client', NULL, NULL, NULL, 20, 50000, '30%', 100000, 'CENT VINGT MILLE', 'non préparé', 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', NULL, 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, 'G6 à faire', 'accordé', '91175', '2021-04-23 15:47:12', '2021-04-23 15:47:12', '30%', 'DF21/043', '06-2021', '2021-03-01'),
(26, 'préparé', 'diagnostic stratégique', 2021, 'GIAC 1', 4, '2021-01-18', 25, 175000, 'cabinet', 'cabinet', 'non préparé', 'giac', 'cabinet', 'cabinet', 'non préparé', 'cabinet', 'non préparé', 'giac', 'non préparé', 'non préparé', 'non préparé', 'client', 'giac', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'préparé', '2021-04-23', NULL, 'cabinet', 'non préparé', 'cabinet', 'cabinet', 'giac', 'non préparé', 'giac', 'non préparé', 'giac', '2021-05-18', 'non préparé', NULL, 'non préparé', 'non préparé', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'NOMBRE NON VALIDE', 'non préparé', 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', NULL, 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, 'déposé en ligne : à déposer physiquement', 'déposé', '89005', '2021-04-30 15:01:32', '2021-05-18 11:18:33', '30%', NULL, '07-2021', '2021-02-16'),
(27, 'préparé', 'ingénierie de formation', 2021, 'GIAC 1', 4, '2021-01-18', 23, 138000, 'cabinet', 'non préparé', 'cabinet', 'giac', 'cabinet', 'non préparé', 'cabinet', 'non préparé', 'cabinet', 'giac', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'giac', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'préparé', '2021-04-23', '300000', 'cabinet', 'non préparé', 'cabinet', 'cabinet', 'non préparé', 'giac', 'non préparé', 'giac', 'giac', '2021-05-18', 'non préparé', NULL, 'non préparé', 'non préparé', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'NOMBRE NON VALIDE', 'non préparé', 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', NULL, 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, 'DF déposée en ligne : à déposer physiquement', 'déposé', '89005', '2021-04-30 15:04:09', '2021-05-18 11:21:26', '20%', NULL, '08-2021', '2021-02-16'),
(28, 'préparé', 'diagnostic stratégique', 2021, 'GIAC 1', 4, '2021-05-06', 18, 126000, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'non préparé', 'non préparé', NULL, NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, 'non préparé', NULL, 'non préparé', 'non préparé', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'NOMBRE NON VALIDE', 'non préparé', 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', NULL, 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, NULL, 'instruction dossier', '77267', '2021-05-06 10:09:27', '2021-05-06 10:57:41', '30%', NULL, NULL, NULL),
(29, 'Préparé', 'Ingénierie de formation', 2021, 'GIAC 1', 4, '2021-05-06', 17, 102000, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'ofppt', 'non préparé', 'non préparé', NULL, '143737', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, 'non préparé', NULL, 'non préparé', 'non préparé', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'NOMBRE NON VALIDE', 'non préparé', 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', NULL, 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, NULL, 'instruction dossier', '77267', '2021-05-06 10:13:20', '2021-05-06 10:13:20', '20%', NULL, NULL, NULL),
(30, 'Préparé', 'diagnostic stratégique', 2021, 'GIAC 1', 4, '2021-05-10', 28, 140000, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, 'non préparé', NULL, 'non préparé', 'non préparé', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'NOMBRE NON VALIDE', 'non préparé', 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', NULL, 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, NULL, 'instruction dossier', '32891', '2021-05-24 09:54:41', '2021-05-24 09:54:41', '30%', NULL, NULL, NULL),
(31, 'Préparé', 'Ingénierie de formation', 2021, 'GIAC 1', 4, '2021-05-10', 28, 140000, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, 'non préparé', NULL, 'non préparé', 'non préparé', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'NOMBRE NON VALIDE', 'non préparé', 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', NULL, 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, NULL, 'instruction dossier', '32891', '2021-05-24 09:55:39', '2021-05-24 09:55:39', '20%', NULL, NULL, NULL),
(32, 'Préparé', 'Ingénierie de formation', 2021, 'GIAC TRANSLOG', 4, '2021-05-10', 24, 120000, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, 'non préparé', NULL, 'non préparé', 'non préparé', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'NOMBRE NON VALIDE', 'non préparé', 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', NULL, 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, NULL, 'instruction dossier', '230901', '2021-05-24 09:58:33', '2021-05-24 09:58:33', '20%', NULL, NULL, NULL);
...
CREATE TABLE `demande_remboursement_giacs` (
  ...
  `ref_fin` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT 'non préparé',
  ...
  `ref_rb` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT 'non préparé',
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `n_facture_2` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dt_facture_2` date DEFAULT NULL,
  `dt_fact_cab_entr` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `demande_remboursement_giacs` (`n_drb`, `n_facture`, `dt_facture`, `fact_cab_entr`, `relv_banc_cab`, `relv_banc_entrp`, `drb_ds`, `drb_if`, `frai_doss`, `dt_pay_entrp`, `moyen_fin`, `ref_fin`, `avis_remise_fin`, `part_giac`, `montant_entrp_ttc`, `montant_entrp_ht`, `dt_depo_drb`, `dt_rb`, `moyen_rb`, `ref_rb`, `montant_rb`, `etat`, `commentaire`, `n_df`, `created_at`, `updated_at`, `n_facture_2`, `dt_facture_2`, `dt_fact_cab_entr`) VALUES
(4, '47-2020', '2020-12-03', 'préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-04-27', 'chèque', 'AUE N° 279151', 'non préparé', '70%', '40000.00', '80000', NULL, NULL, 'non préparé', NULL, '56000', 'payé', NULL, 2, '2020-11-16 13:24:11', '2021-04-27 15:40:51', NULL, NULL, '2021-02-26'),
(5, '48-2020', '2020-12-03', 'préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-04-27', 'chèque', 'AUE N° 279152', 'non préparé', '80%', '20000.00', '50000', NULL, NULL, 'non préparé', NULL, '40000', 'payé', NULL, 3, '2020-11-16 13:51:43', '2021-04-27 15:41:56', NULL, NULL, '2021-02-26'),
(6, '49-2020', '2020-12-03', 'préparé', 'préparé', 'préparé', 'non préparé', 'non préparé', 'non préparé', '2021-04-01', 'virement', 'VC175417', 'remise', '70%', '30000.00', '60000', '2021-05-12', NULL, 'non préparé', NULL, '42000', 'déposé', 'On doit déposer la facture N° 49-2020 chez GIAC alors qu\' on va comptabiliser la facture N° 08-2021', 4, '2020-11-16 14:30:55', '2021-05-18 08:40:00', NULL, NULL, '2021-03-04'),
(7, '34-2020', '2020-08-13', 'préparé', 'préparé', 'préparé', 'non préparé', 'non préparé', 'non préparé', '2020-09-18', 'effet', 'ELC N 7218124', 'avis', '70%', '25000.00', '50000', '2020-10-16', '2020-10-19', 'chèque', 'CMI N° 7919118', '35000', 'remboursé', NULL, 5, '2020-11-17 06:36:52', '2020-11-23 07:21:58', NULL, NULL, NULL),
(8, '37-2020', '2020-10-20', 'préparé', 'préparé', 'préparé', 'non préparé', 'non préparé', 'préparé', '2020-10-27', 'virement', 'VRT', 'remise', '80%', '19200.00', '48000', '2020-11-23', '2020-11-23', 'chèque', 'CMI N° 7919146', '38400', 'remboursé', NULL, 6, '2020-11-17 08:36:20', '2020-12-16 12:24:00', NULL, NULL, NULL),
(9, '55-2020', '2020-12-03', 'préparé', 'préparé', 'préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-19', 'chèque', 'MFCN°3539066', 'avis', '70%', '30250.00', '60500', '2021-01-27', NULL, 'non préparé', 'nul', '42350', 'déposé', NULL, 8, '2020-11-17 09:48:48', '2021-03-15 10:29:12', NULL, NULL, NULL),
(10, '51-2020', '2020-12-03', '', '', '', '', '', '', '0000-00-00', 'non préparé', '', 'pas encore', '70%', '35000.00', '70000', NULL, NULL, 'non préparé', '', '49000', 'initié', NULL, 9, '2020-11-17 10:40:58', '2020-11-17 10:40:58', NULL, NULL, NULL),
(11, '46-2020', '2020-12-03', 'préparé', 'préparé', 'préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-18', 'chèque', 'EGC N°7210137', 'avis', '70%', '24000.00', '48000', '2021-02-16', '2021-03-29', 'chèque', 'EGC N°9097389', '33600', 'remboursé', NULL, 10, '2020-11-17 11:08:18', '2021-03-31 09:14:59', NULL, NULL, '2021-01-15'),
(14, '52-2020', '2020-12-03', '', '', '', '', '', '', '0000-00-00', 'non préparé', '', 'pas encore', '70%', '40000.00', '80000', NULL, NULL, 'non préparé', '', '56000', 'initié', NULL, 13, '2020-11-17 13:04:25', '2020-11-17 13:04:25', NULL, NULL, NULL),
(16, '53-2020', '2020-12-03', '', '', '', '', '', '', '0000-00-00', 'non préparé', '', 'pas encore', '80%', '28800.00', '72000', NULL, NULL, 'non préparé', '', '57600', 'initié', NULL, 15, '2020-11-17 13:55:43', '2020-11-17 13:55:43', NULL, NULL, NULL),
(17, '54-2020', '2020-12-03', '', '', '', '', '', '', '0000-00-00', 'non préparé', '', 'pas encore', '80%', '36000.00', '90000', NULL, NULL, 'non préparé', '', '72000', 'initié', NULL, 16, '2020-11-17 14:09:01', '2020-11-17 14:09:01', NULL, NULL, NULL),
(18, '50-2020', '2020-12-03', 'préparé', 'préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-15', 'chèque', 'MFC N°3539065', 'avis', '70%', '33000.00', '66000', NULL, NULL, 'non préparé', 'non préparé', '46200', 'instruction dossier', 'A finaliser rapport', 7, '2020-12-02 15:38:28', '2021-01-28 13:48:09', NULL, NULL, NULL),
(19, '56-2020', '2020-12-03', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '0000-00-00', 'non préparé', 'non préparé', 'non préparé', '70%', '60000.00', '120000', NULL, NULL, 'non préparé', 'non préparé', '84000', 'initié', NULL, 17, '2020-12-03 08:33:06', '2020-12-03 08:33:06', NULL, NULL, NULL),
(25, '57-2020', '2020-12-03', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '0000-00-00', 'non préparé', 'non préparé', 'non préparé', '80%', '40000.00', '100000', NULL, NULL, 'non préparé', 'non préparé', '80000', 'initié', NULL, 18, '2020-12-03 08:52:29', '2020-12-03 08:52:29', NULL, NULL, NULL),
(26, '58-2020', '2020-12-03', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '0000-00-00', 'non préparé', 'non préparé', 'non préparé', '70%', '40000.00', '80000', NULL, NULL, 'non préparé', 'non préparé', '56000', 'initié', NULL, 11, '2020-12-03 08:55:35', '2020-12-03 08:55:35', NULL, NULL, NULL),
(27, '59-2020', '2020-12-03', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '0000-00-00', 'non préparé', 'non préparé', 'non préparé', '70%', '37500.00', '75000', NULL, NULL, 'non préparé', 'non préparé', '52500', 'initié', NULL, 12, '2020-12-03 08:58:03', '2020-12-03 08:58:03', NULL, NULL, NULL),
(31, '60-2020', '2020-12-03', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '0000-00-00', 'non préparé', 'non préparé', 'non préparé', '70%', '40000.00', '80000', NULL, NULL, 'non préparé', 'non préparé', '56000', 'initié', NULL, 14, '2020-12-03 09:02:51', '2020-12-03 09:02:51', NULL, NULL, NULL),
(36, NULL, NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-03-03', '1', '0', 'non préparé', '70%', '5000.00', '10000', NULL, NULL, 'non préparé', 'non préparé', '7000', 'payé', NULL, 1, '2020-12-03 09:21:30', '2021-03-03 07:53:40', '###TEST###', '2020-11-10', NULL),
(37, NULL, NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', '70%', '20000.00', '40000', NULL, NULL, 'non préparé', 'non préparé', '28000', 'initié', NULL, 22, '2021-03-30 13:52:47', '2021-03-30 13:52:47', NULL, NULL, NULL),
(38, NULL, NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', '70%', '15000.00', '30000', NULL, NULL, 'non préparé', 'non préparé', '21000', 'initié', NULL, 23, '2021-03-30 15:35:20', '2021-03-30 15:35:20', NULL, NULL, NULL),
(39, NULL, NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', '80%', '6000.00', '15000', NULL, NULL, 'non préparé', 'non préparé', '12000', 'initié', NULL, 24, '2021-03-30 15:58:12', '2021-03-30 15:58:12', NULL, NULL, NULL),
(40, NULL, NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', '70%', '25000.00', '50000', NULL, NULL, 'non préparé', 'non préparé', '35000', 'initié', NULL, 20, '2021-04-02 12:30:04', '2021-04-02 12:30:04', NULL, NULL, NULL),
(41, NULL, NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', '80%', '20000.00', '50000', NULL, NULL, 'non préparé', 'non préparé', '40000', 'initié', NULL, 21, '2021-04-02 12:30:26', '2021-04-02 12:30:26', NULL, NULL, NULL),
(42, NULL, NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', NULL, 'non préparé', 'non préparé', 'non préparé', '70%', '50000.00', '100000', NULL, NULL, 'non préparé', 'non préparé', '70000', 'initié', NULL, 25, '2021-04-23 15:47:12', '2021-04-23 15:47:12', NULL, NULL, NULL);
...
(32, 'Affaires juridiques', 'Grand Casablanca', 'Settat', 5000, NULL, '2021-02-12 11:24:30', '2021-02-12 11:24:30'),
(33, 'Affaires juridiques', 'Grand Casablanca', 'Casablanca', 6000, NULL, '2021-02-12 11:47:35', '2021-02-12 11:47:35'),
(34, 'Affaires juridiques', 'Grand Casablanca', 'Settat', 6000, NULL, '2021-02-12 13:26:35', '2021-02-12 13:26:35');
...
(43, '04-2021', '2021-02-26', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-07', '2021-01-08', '2021-01-09', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 51, NULL, '2020-10-20 13:12:13', '2020-10-21 09:35:45'),
(44, '05-2021', '2021-02-26', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-14', '2021-01-15', '2021-01-16', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 52, NULL, '2020-10-20 13:12:56', '2020-10-21 09:36:05'),
(45, '06-2021', '2021-02-26', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-21', '2021-01-22', '2021-01-23', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 53, NULL, '2020-10-20 13:21:18', '2020-10-21 09:36:32'),
(46, '07-2021', '2021-02-26', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-28', '2021-01-29', '2021-01-30', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 54, NULL, '2020-10-20 13:21:53', '2020-10-21 09:37:00'),
...
(69, '08-2021', '2021-03-02', 1, '6', '09:00', '16:00', '12:30', '13:30', '2021-01-07', '2021-01-08', '2021-01-09', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 76, NULL, '2020-10-22 05:11:08', '2020-10-22 11:26:25'),
(70, '10-2021', '2021-03-02', 1, '6', '09:00', '16:00', '12:30', '13:30', '2021-01-14', '2021-01-15', '2021-01-16', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 77, NULL, '2020-10-22 05:11:33', '2020-10-22 11:26:48'),
(71, '11-2021', '2021-03-02', 1, '6', '09:00', '16:00', '12:30', '13:30', '2021-01-21', '2021-01-22', '2021-01-23', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 78, NULL, '2020-10-22 05:12:03', '2020-10-22 11:27:11'),
(72, '12-2021', '2021-03-02', 1, '6', '09:00', '16:00', '12:30', '13:30', '2021-01-29', '2021-01-30', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 79, NULL, '2020-10-22 05:12:25', '2020-10-22 11:27:36'),
(73, '13-2021', '2021-03-02', 1, '6', '09:00', '16:00', '12:30', '13:30', '2021-01-05', '2021-02-06', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 80, NULL, '2020-10-22 05:12:45', '2020-10-22 11:29:15'),
(74, '14-2021', '2021-03-02', 1, '6', '09:00', '16:00', '12:30', '13:30', '2021-02-11', '2021-02-12', '2021-02-13', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 81, NULL, '2020-10-22 05:13:12', '2020-10-22 11:29:37'),
(75, '15-2021', '2021-03-02', 1, '6', '09:00', '16:00', '12:30', '13:30', '2021-02-18', '2021-02-19', '2021-02-20', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 82, NULL, '2020-10-22 05:13:41', '2020-10-22 11:29:56'),
(76, '16-2021', '2021-03-02', 1, '6', '09:00', '16:00', '12:30', '13:30', '2021-02-25', '2021-02-26', '2021-02-27', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 83, NULL, '2020-10-22 05:14:09', '2020-10-22 11:30:24'),
...
(81, '20-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-02', '2021-01-07', '2021-01-08', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 88, NULL, '2020-10-22 06:11:10', '2021-01-22 11:28:18'),
(82, '21-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-09', '2021-01-14', '2021-01-15', '2021-01-16', '2021-01-21', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 89, NULL, '2020-10-22 06:12:06', '2020-10-22 06:12:06'),
...
(100, '30-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-07', '2021-01-08', '2021-01-09', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 100, NULL, '2020-10-23 08:28:06', '2020-10-23 08:28:06'),
(101, '31-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-14', '2021-01-15', '2021-01-16', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 101, NULL, '2020-10-23 08:28:32', '2020-10-23 08:28:32'),
(102, '32-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-21', '2021-01-22', '2021-01-23', '2021-01-28', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 102, NULL, '2020-10-23 08:29:11', '2020-10-23 08:29:11'),
(103, '33-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-29', '2021-01-30', '2021-02-04', '2021-02-05', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 103, NULL, '2020-10-23 08:29:52', '2020-10-23 08:29:52'),
...
(108, '26-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-07', '2021-01-08', '2021-01-09', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 108, NULL, '2020-10-23 08:52:01', '2020-10-23 08:52:01'),
(109, '27-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-14', '2021-01-15', '2021-01-16', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 109, NULL, '2020-10-23 08:52:33', '2020-10-23 08:52:33'),
(110, '28-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-21', '2021-01-22', '2021-01-23', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 110, NULL, '2020-10-23 08:53:07', '2020-10-23 08:53:07'),
(111, '29-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-28', '2021-01-29', '2021-01-30', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 111, NULL, '2020-10-23 08:53:44', '2020-10-23 08:53:44'),
...
(113, '89-2020', '2020-12-28', 1, '5', '09:00', '16:00', '12:30', '13:30', '2020-12-03', '2020-12-04', '2020-12-05', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 113, 'le montant facturé et comptabilisé : 21000', '2020-10-23 10:02:26', '2021-03-31 10:56:13'),
...
(116, '48-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2020-12-31', '2021-01-07', '2021-01-08', '2021-01-09', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 116, NULL, '2020-10-23 10:04:23', '2020-10-23 10:04:23'),
(117, '49-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-14', '2021-01-15', '2021-01-16', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 117, NULL, '2020-10-23 10:04:53', '2020-10-23 10:04:53'),
(118, '50-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-21', '2021-01-22', '2021-01-23', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 118, NULL, '2020-10-23 10:05:21', '2020-10-23 10:05:21'),
(119, '51-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-28', '2021-01-29', '2021-01-30', '2021-02-04', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 119, NULL, '2020-10-23 10:06:09', '2020-10-23 10:06:09'),
(120, '52-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-02-05', '2021-02-06', '2021-02-11', '2021-02-12', '2021-02-13', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 120, NULL, '2020-10-23 10:06:58', '2020-10-23 10:06:58'),
(121, '53-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-02-18', '2021-02-19', '2021-02-20', '2021-02-26', '2021-02-27', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 121, NULL, '2020-10-23 10:07:58', '2020-10-23 10:07:58'),
(122, '54-2021', '2021-03-08', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-03-04', '2021-03-05', '2021-03-06', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 122, NULL, '2020-10-23 10:08:27', '2020-10-23 10:08:27'),
...
(127, '22-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-07', '2021-01-08', '2021-01-09', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 127, NULL, '2020-10-23 10:55:32', '2020-10-23 10:55:32'),
(128, '23-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-14', '2021-01-15', '2021-01-16', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 128, NULL, '2020-10-23 10:56:08', '2020-10-23 10:56:08'),
(129, '24-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-21', '2021-01-22', '2021-01-23', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 129, NULL, '2020-10-23 10:56:46', '2020-10-23 10:56:46'),
(130, '25-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-28', '2021-01-29', '2021-01-30', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 130, NULL, '2020-10-23 10:57:35', '2020-10-23 10:57:35'),
...
(135, '42-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-07', '2021-01-08', '2021-01-09', '2021-01-14', '2021-01-15', '2021-01-16', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 135, NULL, '2020-10-23 12:36:35', '2020-10-23 12:36:35'),
(136, '43-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-21', '2021-01-22', '2021-01-23', '2021-01-28', '2021-01-29', '2021-01-30', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 136, NULL, '2020-10-23 12:37:29', '2020-10-23 12:37:29'),
(137, '44-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-02-04', '2021-02-05', '2021-02-06', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 137, NULL, '2020-10-23 12:38:01', '2020-10-23 12:38:01'),
(138, '45-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-02-11', '2021-02-12', '2021-02-13', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 138, NULL, '2020-10-23 12:38:48', '2020-10-23 12:38:48'),
(139, '46-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-02-18', '2021-02-19', '2021-02-20', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 139, NULL, '2020-10-23 12:40:54', '2020-10-23 12:40:54'),
(140, '47-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-02-25', '2021-02-26', '2021-02-27', '2021-03-04', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 140, NULL, '2020-10-23 12:41:36', '2020-10-23 12:41:36'),
...
(145, '55-2021', '2021-03-15', 1, '5', '09:00', '16:00', '12:30', '13:30', '2020-12-25', '2020-12-26', '2020-12-31', '2021-01-07', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 145, NULL, '2020-10-23 14:34:11', '2020-10-24 08:23:33'),
(146, '56-2021', '2021-03-15', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-08', '2021-01-09', '2021-01-15', '2021-01-16', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 146, NULL, '2020-10-23 14:35:43', '2020-10-24 08:24:04'),
(147, '57-2021', '2021-03-15', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-21', '2021-01-22', '2021-01-23', '2021-01-28', '2021-01-29', '2021-01-30', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 147, NULL, '2020-10-23 14:36:31', '2020-10-24 08:24:41'),
(148, '58-2021', '2021-03-15', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-02-04', '2021-02-05', '2021-02-06', '2021-02-11', '2021-02-12', '2021-02-13', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 148, NULL, '2020-10-23 14:37:25', '2020-10-24 08:25:19'),
(149, '59-2021', '2021-03-15', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-02-18', '2021-02-19', '2021-02-20', '2021-02-25', '2021-02-26', '2021-02-27', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 149, NULL, '2020-10-23 14:38:10', '2020-10-24 08:25:56'),
(150, '60-2021', '2021-03-15', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-03-04', '2021-03-05', '2021-03-06', '2021-03-11', '2021-03-12', '2021-03-13', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 150, NULL, '2020-10-23 14:39:05', '2020-10-24 08:26:27'),
...
(162, '34-2021', '2021-03-05', 1, '6', '09:00', '16:00', '12:30', '13:30', '2021-01-07', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 162, NULL, '2020-11-02 08:13:12', '2020-12-02 10:09:39'),
(163, '35-2021', '2021-03-05', 1, '6', '09:00', '16:00', '12:30', '13:30', '2021-01-08', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 163, NULL, '2020-11-02 08:13:48', '2020-12-02 10:16:40'),
(164, '36-2021', '2021-03-05', 1, '6', '09:00', '16:00', '12:30', '13:30', '2021-01-09', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 164, NULL, '2020-11-02 08:14:15', '2021-01-12 11:10:10'),
(165, '37-2021', '2021-03-05', 1, '6', '09:00', '16:00', '12:30', '13:30', '2021-01-14', '2021-01-15', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 165, NULL, '2020-11-02 08:14:42', '2020-11-02 08:14:42');
INSERT INTO `formations` (`id_form`, `n_facture`, `dt_facture`, `groupe`, `nb_benif`, `hr_debut`, `hr_fin`, `pse_debut`, `pse_fin`, `date1`, `date2`, `date3`, `date4`, `date5`, `date6`, `date7`, `date8`, `date9`, `date10`, `date11`, `date12`, `date13`, `date14`, `date15`, `date16`, `date17`, `date18`, `date19`, `date20`, `date21`, `date22`, `date23`, `date24`, `date25`, `date26`, `date27`, `date28`, `date29`, `date30`, `n_form`, `commentaire`, `created_at`, `updated_at`) VALUES
(166, '38-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-01-16', '2021-01-21', '2021-01-22', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 166, NULL, '2020-11-02 08:15:07', '2020-12-02 10:07:03'),
(167, '39-2021', '2021-03-05', 1, '6', '09:00', '16:00', '12:30', '13:30', '2021-01-29', '2021-01-30', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 167, NULL, '2020-11-02 08:16:15', '2020-12-02 10:35:08'),
(168, '40-2021', '2021-03-05', 1, '5', '09:00', '16:00', '12:30', '13:30', '2021-02-05', '2021-02-06', '2021-02-11', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 168, NULL, '2020-11-02 08:16:56', '2020-12-02 10:38:36'),
(169, '41-2021', '2021-03-05', 1, '6', '09:00', '16:00', '12:30', '13:30', '2021-02-12', '2021-02-13', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 169, NULL, '2020-11-02 08:17:31', '2020-12-02 10:42:23'),
...
('BB13022', 155, '2021-02-01 14:11:59', '2021-02-01 14:11:59'),
('BB145767', 16, '2020-10-28 14:33:37', '2020-10-28 14:33:37'),
('BB151229', 17, '2020-09-24 11:07:30', '2020-09-24 11:07:30'),
('BB31037', 155, '2021-02-01 14:11:59', '2021-02-01 14:11:59'),
...
('BK102859', 155, '2021-02-01 14:11:59', '2021-02-01 14:11:59'),
...
('C306095', 155, '2021-02-01 14:11:59', '2021-02-01 14:11:59'),
...
('D613577', 155, '2021-02-01 14:11:59', '2021-02-01 14:11:59'),
...
('JE143248', 155, '2021-02-01 14:11:59', '2021-02-01 14:11:59'),
...
(1, 'Belmokadem', 'Adil', 'Stratégie et Management', 'Stratégie et Management', 'Législation du travail', '+21261223138', 'a.belmokadem@mediexperts.ma', 'Anglais, Français, Arabe', 'occupé', 0x696d672f696e746572762d66696c65732f313539363533373531302d43562e6a7067, '171287', NULL, '2020-08-04 05:38:30', '2021-03-31 10:54:30'),
...
(18, 'BELAMINE', 'Youssef', 'INGENIEUR CONSEIL EN FORMATION CONTINUE', 'STRATEGIE ET ORGANISATION DES ENTREPRISES', 'Technique De Pré-Vente', '0661335585', 'belamine8@gmail.com', 'Arabe / Français / Anglais', 'occupé', 0x696d672f696e746572762d66696c65732f313630353038363831392d43562e646f63, '171287', NULL, '2020-11-11 06:26:59', '2021-02-01 14:14:34'),
...
(20, '2021_03_01_100915_create_old_action_formations', 2),
(21, '2021_03_01_100946_create_old_formations', 2),
(22, '2021_03_12_085324_add_approb', 2),
(23, '2021_03_12_100045_add_store__n__contrat', 3),
(24, '2021_03_12_095215_add_atabrob', 4);
...
--
-- Structure de la table `old_action_formations`
--

CREATE TABLE `old_action_formations` (
  `old_n_form` bigint(20) UNSIGNED NOT NULL,
  `old_id_dom` varchar(300) COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_id_thm` varchar(300) COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_n_action` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_model5` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'non préparé',
  `old_model3` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'non préparé',
  `old_f4` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'non préparé',
  `old_fiche_eval` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'non préparé',
  `old_support_form` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'non préparé',
  `old_cv_inv` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'non préparé',
  `old_avis_affich` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'non préparé',
  `old_dt_debut` date NOT NULL,
  `old_dt_fin` date NOT NULL,
  `old_nb_jour` int(11) NOT NULL,
  `old_nb_heure` int(11) DEFAULT NULL,
  `old_type_form` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_organisme` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_lieu` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_nom_resp` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_nb_grp` int(11) NOT NULL,
  `old_nb_partcp_total` int(11) NOT NULL,
  `old_nb_cadre` int(11) NOT NULL,
  `old_nb_employe` int(11) NOT NULL,
  `old_nb_ouvrier` int(11) NOT NULL,
  `old_bdg_jour` double NOT NULL,
  `old_bdg_total` double NOT NULL,
  `old_bdg_letter` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `old_etat` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'aucun',
  `old_id_inv` bigint(20) UNSIGNED NOT NULL,
  `old_id_plan` bigint(20) UNSIGNED NOT NULL,
  `old_commentaire` varchar(5000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Structure de la table `old_formations`
--

CREATE TABLE `old_formations` (
  `old_id_form` bigint(20) UNSIGNED NOT NULL,
  `old_n_facture` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `old_dt_facture` date DEFAULT NULL,
  `old_groupe` int(11) NOT NULL DEFAULT 0,
  `old_nb_benif` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_hr_debut` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_hr_fin` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_pse_debut` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_pse_fin` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_date1` date NOT NULL,
  `old_date2` date DEFAULT NULL,
  `old_date3` date DEFAULT NULL,
  `old_date4` date DEFAULT NULL,
  `old_date5` date DEFAULT NULL,
  `old_date6` date DEFAULT NULL,
  `old_date7` date DEFAULT NULL,
  `old_date8` date DEFAULT NULL,
  `old_date9` date DEFAULT NULL,
  `old_date10` date DEFAULT NULL,
  `old_date11` date DEFAULT NULL,
  `old_date12` date DEFAULT NULL,
  `old_date13` date DEFAULT NULL,
  `old_date14` date DEFAULT NULL,
  `old_date15` date DEFAULT NULL,
  `old_date16` date DEFAULT NULL,
  `old_date17` date DEFAULT NULL,
  `old_date18` date DEFAULT NULL,
  `old_date19` date DEFAULT NULL,
  `old_date20` date DEFAULT NULL,
  `old_date21` date DEFAULT NULL,
  `old_date22` date DEFAULT NULL,
  `old_date23` date DEFAULT NULL,
  `old_date24` date DEFAULT NULL,
  `old_date25` date DEFAULT NULL,
  `old_date26` date DEFAULT NULL,
  `old_date27` date DEFAULT NULL,
  `old_date28` date DEFAULT NULL,
  `old_date29` date DEFAULT NULL,
  `old_date30` date DEFAULT NULL,
  `old_n_form` bigint(20) UNSIGNED NOT NULL,
  `old_id_inv` bigint(20) UNSIGNED NOT NULL,
  `commentaire` varchar(5000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
('BB13022', 38174, 'EL MACHRAFI', 'RACHIDA', '114036760', '1970-01-01', '1970-01-01', '1970-01-01', 'Agent Adm des Ventes', 'E', 'Disponible', '91175', '2021-02-01 14:10:25', '2021-02-01 14:10:25'),
...
('BB31037', 22555, 'BARISE', 'HASSAN', '184712952', '1970-01-01', '1970-01-01', '1970-01-01', 'VENDEUR', 'E', 'Disponible', '91175', '2021-02-01 14:10:25', '2021-02-01 14:10:25'),
...
('BK102859', 14876, 'EL BOUDRARI', 'ALI', '122126850', '1970-01-01', '1970-01-01', '1970-01-01', 'VENDEUR LIVREUR', 'E', 'Disponible', '91175', '2021-02-01 14:10:25', '2021-02-01 14:10:25'),
...
('C306095', 12443, 'ZDAALI', 'MOHAMED', '127848235', '1970-01-01', '1970-01-01', '1970-01-01', 'VENDEUR LIVREUR', 'E', 'Disponible', '91175', '2021-02-01 14:10:25', '2021-02-01 14:10:25'),
...
('D613577', 41786, 'EL QIHRA', 'ABDELKADER', '193933482', '1970-01-01', '1970-01-01', '1970-01-01', 'VENDEUR LIVREUR', 'E', 'Disponible', '91175', '2021-02-01 14:10:25', '2021-02-01 14:10:25'),
...
('JE143248', 96872, 'BAFKIR', 'HASSAN', '152450758', '1970-01-01', '1970-01-01', '1970-01-01', 'VENDEUR LIVREUR OCCASIONNEL', 'E', 'Disponible', '91175', '2021-02-01 14:10:25', '2021-02-01 14:10:25'),
...
CREATE TABLE `plans` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `at_approb_if` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT 'non préparé',
  `at_approb_ds` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT 'non préparé',
  `n_contrat` varchar(155) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `plans` (`id_plan`, `refpdf`, `annee`, `ct_PF`, `dt_recep_ct`, `dt_contrat_PFOPT`, `l_tierpay_PF`, `at_approb_PFOPT`, `rpt_DS_PFOPT`, `rpt_IF_PFOPT`, `f2_PFOPT`, `model1_PFOPT`, `rib_PFOPT`, `f3_PFOPT`, `at_qualif_PFOPT`, `eligib_cab_PFOPT`, `accuse_PFOPT`, `dt_accuse_PFOPT`, `etat`, `nrc_e`, `commentaire`, `created_at`, `updated_at`, `at_approb_if`, `at_approb_ds`, `n_contrat`) VALUES
(7, 'CALZ/2019', '2019', 'client', NULL, NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'préparé', '2019-09-30', 'réalisé', '7077', NULL, '2020-09-03 07:27:47', '2020-09-03 07:27:47', 'non préparé', 'non préparé', NULL),
(10, 'VIVO/2010', '2010', 'ofppt', '2020-09-16', '2020-09-16', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', '2020-09-16', 'planifié', '11111', NULL, '2020-09-17 05:53:00', '2020-09-17 05:53:00', 'non préparé', 'non préparé', NULL),
(11, 'LGSZ/2019', '2019', 'client', '2020-02-01', NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'préparé', '2019-09-30', 'réalisé', '286479', NULL, '2020-09-17 07:02:31', '2020-09-17 07:02:31', 'non préparé', 'non préparé', NULL),
(12, 'ZC/2019', '2019', 'ofppt', '2020-02-01', '2020-12-25', 'préparé', 'préparé', 'non préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', '2019-09-30', 'réalisé', '5587', NULL, '2020-09-17 10:20:53', '2021-02-25 15:42:35', 'non préparé', 'non préparé', NULL),
(13, 'CF/2019', '2019', 'client', '2020-02-01', NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-09-30', 'réalisé', '143199', NULL, '2020-09-18 04:35:24', '2020-09-18 04:35:24', 'non préparé', 'non préparé', NULL),
(14, 'LGMZ/2019', '2019', 'client', '2020-02-02', NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'préparé', '2019-01-30', 'réalisé', '193231', NULL, '2020-09-18 06:45:28', '2020-09-18 06:45:28', 'non préparé', 'non préparé', NULL),
(15, 'TRSD/2019', '2019', 'client', '2020-02-01', NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'préparé', '2019-01-30', 'réalisé', '117713', NULL, '2020-09-18 09:42:19', '2020-09-18 09:42:19', 'non préparé', 'non préparé', NULL),
(16, 'ZCI/2019', '2019', 'client', '2020-02-01', NULL, 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'préparé', '2019-01-31', 'réalisé', '328729', NULL, '2020-09-18 11:00:48', '2020-09-18 11:00:48', 'non préparé', 'non préparé', NULL),
(17, 'Uplift/2019', '2019', 'ofppt', '2020-02-01', '2020-09-16', 'non préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'non préparé', 'préparé', 'préparé', '2019-09-30', 'réalisé', '376161', NULL, '2020-09-23 04:30:08', '2020-10-05 08:26:36', 'non préparé', 'non préparé', NULL),
(18, 'VIVO/2000', '2000', 'client', NULL, '2020-09-24', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'préparé', '2020-09-24', 'planifié', '11111', 'Lorem Ipsum er ganske enkelt fyldtekst fra print- og typografiindustrien. Lorem Ipsum har været standard fyldtekst siden 1500-tallet, hvor en ukendt trykker sammensatte en tilfældig spalte for at trykke en bog til sammenligning af forskellige skrifttyper. Lorem Ipsum har ikke alene overlevet fem århundreder, men har også vundet indpas i elektronisk typografi uden væsentlige ændringer. Sætningen blev gjordt kendt i 1960\'erne med lanceringen af Letraset-ark, som indeholdt afsnit med Lorem Ipsum, og senere med layoutprogrammer som Aldus PageMaker, som også indeholdt en udgave af Lorem Ipsum.', '2020-09-25 10:08:25', '2020-11-11 08:27:40', 'non préparé', 'non préparé', NULL),
(19, 'SGLOBAL/2020', '2020', 'ofppt', '2021-02-18', '2021-04-16', 'préparé', 'préparé', 'non préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'non préparé', NULL, 'réalisé', '254391', NULL, '2020-10-05 12:12:07', '2021-04-20 14:54:46', 'préparé', 'non préparé', NULL),
(20, 'HAVA/2020', '2020', 'ofppt', '2021-02-17', '2021-03-09', 'préparé', 'préparé', 'non préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'non préparé', NULL, 'réalisé', '296871', NULL, '2020-10-20 09:10:24', '2021-03-09 14:49:10', 'non préparé', 'non préparé', NULL),
(21, 'SCRH/2020', '2020', 'cabinet', '2021-02-26', NULL, 'préparé', 'préparé', 'non préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'non préparé', NULL, 'réalisé', '251529', NULL, '2020-10-20 12:23:08', '2021-02-26 14:20:16', 'non préparé', 'non préparé', NULL),
(22, 'MATIPLAS/2020', '2020', 'ofppt', '2021-02-17', '2021-03-09', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'non préparé', NULL, 'réalisé', '45307', NULL, '2020-10-21 11:55:17', '2021-03-09 14:49:52', 'non préparé', 'non préparé', NULL),
(23, 'BURINTEL/2020', '2020', 'ofppt', '2021-02-23', NULL, 'préparé', 'préparé', 'non préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'non préparé', '2020-10-27', 'réalisé', '103827', '23/02/2021: contrat erroné -déposé le 24 pour modification.', '2020-10-21 13:35:43', '2021-02-25 15:35:58', 'non préparé', 'non préparé', NULL),
(24, 'Uplift/2020', '2020', 'cabinet', '2021-02-23', NULL, 'préparé', 'préparé', 'non préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'non préparé', NULL, 'réalisé', '376161', NULL, '2020-10-22 05:49:09', '2021-02-23 10:02:48', 'non préparé', 'non préparé', NULL),
(25, 'LGMZ/2020', '2020', 'cabinet', '2021-02-18', NULL, 'préparé', 'préparé', 'non préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'non préparé', NULL, 'réalisé', '193231', NULL, '2020-10-22 13:27:52', '2021-02-18 15:44:37', 'non préparé', 'non préparé', NULL),
(26, 'ZC/2020', '2020', 'cabinet', '2021-02-12', NULL, 'préparé', 'préparé', 'non préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'non préparé', NULL, 'réalisé', '5587', NULL, '2020-10-23 07:36:32', '2021-02-17 15:10:43', 'non préparé', 'non préparé', NULL),
(27, 'CALZ/2020', '2020', 'cabinet', '2021-02-12', NULL, 'préparé', 'préparé', 'non préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'non préparé', NULL, 'réalisé', '7077', NULL, '2020-10-23 08:39:30', '2021-02-17 15:11:31', 'non préparé', 'non préparé', NULL),
(28, 'BMZ/2020', '2020', 'cabinet', '2021-02-12', NULL, 'préparé', 'préparé', 'non préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'non préparé', NULL, 'planifié', '10963', NULL, '2020-10-23 09:47:18', '2021-02-17 15:07:42', 'non préparé', 'non préparé', NULL),
(29, 'LGSZ/2020', '2020', 'cabinet', '2021-02-12', NULL, 'préparé', 'préparé', 'non préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'non préparé', NULL, 'réalisé', '286479', NULL, '2020-10-23 10:15:26', '2021-02-17 15:12:36', 'non préparé', 'non préparé', NULL),
(30, 'CF/2020', '2020', 'cabinet', '2021-02-18', NULL, 'préparé', 'préparé', 'non préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'non préparé', NULL, 'planifié', '143199', NULL, '2020-10-23 12:12:04', '2021-02-18 15:48:43', 'non préparé', 'non préparé', NULL),
(31, 'TRSD/2020', '2020', 'cabinet', '2021-02-18', NULL, 'préparé', 'préparé', 'non préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'non préparé', NULL, 'planifié', '117713', NULL, '2020-10-23 14:09:20', '2021-02-18 15:49:41', 'non préparé', 'non préparé', NULL),
(32, 'LDF/2020', '2020', 'cabinet', '2021-02-22', NULL, 'préparé', 'non préparé', 'non préparé', 'non préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'non préparé', NULL, 'réalisé', '91175', '22/02/2021 : erreur contrat (à modifier)\r\n23/02/2021 : contrat corrigé récupéré.', '2020-11-02 07:40:05', '2021-02-23 10:06:57', 'non préparé', 'non préparé', NULL),
(33, 'HAVA/2019', '2019', 'ofppt', '2020-02-13', '2020-03-10', 'non préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'non préparé', 'préparé', 'préparé', '2019-09-26', 'réalisé', '296871', 'Contrat normal, une partie avec le Cabinet VALUE Experts Group', '2020-11-11 05:53:02', '2020-11-11 05:53:02', 'non préparé', 'non préparé', NULL),
(34, 'SGLOBAL/2019', '2019', 'ofppt', '2020-01-29', NULL, 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', '2020-09-30', 'réalisé', '254391', 'à reclasser N° TF', '2020-11-23 11:39:18', '2020-11-24 07:49:36', 'non préparé', 'non préparé', NULL);
...
CREATE TABLE `plan_formations` (
  ...
  `at_approb_ds` varchar(155) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `plan_formations` (`n_form`, `id_dom`, `id_thm`, `n_action`, `model5`, `model3`, `f4`, `fiche_eval`, `support_form`, `cv_inv`, `avis_affich`, `dt_debut`, `dt_fin`, `nb_jour`, `type_form`, `organisme`, `lieu`, `nom_resp`, `nb_grp`, `nb_partcp_total`, `nb_cadre`, `nb_employe`, `nb_ouvrier`, `bdg_jour`, `bdg_total`, `bdg_letter`, `etat`, `id_inv`, `id_plan`, `commentaire`, `created_at`, `updated_at`, `nb_heure`, `at_approb_ds`) VALUES
(9, '3', '4', 'TF1', 'préparé', 'préparé', 'préparé', 'préparé', 'non préparé', 'non préparé', 'non préparé', '2019-10-17', '2019-10-19', 3, 'Intra-entreprise', 'Mediexperts', 'COMPLEXE ALIMENTAIRE ZINE', 'Mounir BAZE', 1, 6, 6, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 1, 7, NULL, '2020-09-16 05:30:50', '2021-02-26 11:27:28', 6, NULL),
(10, '4', '5', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-10-24', '2019-10-26', 3, 'Intra-entreprise', 'Mediexperts', 'COMPLEXE ALIMENTAIRE ZINE', 'Mounir BAZE', 1, 6, 0, 6, 0, 7000, 21000, NULL, 'réalisé', 2, 7, NULL, '2020-09-16 05:32:44', '2020-09-16 05:32:44', NULL, NULL),
(11, '4', '6', 'TF3', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-11-05', '2019-11-19', 3, 'Intra-entreprise', 'Mediexperts', 'COMPLEXE ALIMENTAIRE ZINE', 'Mounir BAZE', 1, 6, 6, 0, 0, 7000, 21000, NULL, 'réalisé', 3, 7, NULL, '2020-09-16 05:37:14', '2020-09-16 06:10:33', NULL, NULL),
(13, '6', '33', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'préparé', 'non préparé', '2019-10-31', '2019-11-02', 3, 'Intra-entreprise', 'Mediexperts', 'LES GRANDES SEMOULERIES ZINE', 'BAZE MOUNIR', 1, 6, 3, 3, 0, 7000, 21000, NULL, 'réalisé', 2, 11, NULL, '2020-09-17 07:25:07', '2020-09-24 10:59:50', NULL, NULL),
(14, '6', '34', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'préparé', 'non préparé', '2019-10-17', '2019-10-19', 3, 'Intra-entreprise', 'Mediexperts', 'LES GRANDES SEMOULERIES ZINE', 'BAZE MOUNIR', 1, 6, 2, 4, 0, 7000, 21000, NULL, 'réalisé', 2, 11, NULL, '2020-09-17 07:31:34', '2020-09-24 11:05:12', NULL, NULL),
(15, '7', '11', 'TF3', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'préparé', 'non préparé', '2019-10-24', '2019-10-26', 3, 'Intra-entreprise', 'Mediexperts', 'LES GRANDES SEMOULERIES ZINE', 'BAZE MOUNIR', 1, 6, 0, 6, 0, 6000, 18000, NULL, 'réalisé', 3, 11, NULL, '2020-09-17 08:39:34', '2020-11-05 09:12:37', NULL, NULL),
(16, '4', '10', 'TF4', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-11-07', '2019-11-09', 3, 'Intra-entreprise', 'Mediexperts', 'LES GRANDES SEMOULERIES ZINE', 'BAZE MOUNIR', 1, 6, 0, 6, 0, 7000, 21000, NULL, 'réalisé', 7, 11, NULL, '2020-09-17 08:41:05', '2020-09-17 08:41:05', NULL, NULL),
(17, '8', '12', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'préparé', 'non préparé', '2019-10-17', '2019-10-19', 3, 'Intra-entreprise', 'Mediexperts', 'ZINE CEREALES', 'Mounir BAZE', 1, 6, 0, 6, 0, 7000, 21000, NULL, 'réalisé', 8, 12, NULL, '2020-09-17 10:31:40', '2020-11-02 08:33:35', NULL, NULL),
(18, '6', '14', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-11-07', '2019-11-09', 3, 'Intra-entreprise', 'Mediexperts', 'ZINE CEREALES', 'Mounir BAZE', 1, 6, 6, 0, 0, 7000, 21000, NULL, 'réalisé', 2, 12, NULL, '2020-09-17 10:35:07', '2020-09-17 10:35:07', NULL, NULL),
(19, '22', '118', 'TF3', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-10-24', '2019-10-26', 3, 'Intra-entreprise', 'Mediexperts', 'ZINE CEREALES', 'Mounir BAZE', 1, 6, 0, 6, 0, 6000, 18000, NULL, 'réalisé', 6, 12, NULL, '2020-09-17 10:36:32', '2020-11-02 11:40:04', NULL, NULL),
(20, '10', '21', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-10-17', '2019-10-19', 3, 'Intra-entreprise', 'Mediexperts', 'CANAL FOOD', 'Mounir BAZE', 1, 6, 6, 0, 0, 7500, 22500, NULL, 'réalisé', 9, 13, NULL, '2020-09-18 04:48:29', '2020-09-18 09:07:07', NULL, NULL),
(21, '12', '23', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-12-16', '2019-12-18', 3, 'Intra-entreprise', 'Mediexperts', 'CANAL FOOD', 'Mounir BAZE', 1, 7, 7, 0, 0, 7000, 21000, NULL, 'réalisé', 2, 13, NULL, '2020-09-18 04:50:06', '2020-09-18 09:07:50', NULL, NULL),
(22, '11', '22', 'TF3', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-10-24', '2019-10-26', 3, 'Intra-entreprise', 'Mediexperts', 'CANAL FOOD', 'Mounir BAZE', 1, 6, 6, 0, 0, 7000, 21000, NULL, 'réalisé', 8, 13, NULL, '2020-09-18 04:51:34', '2020-09-18 09:08:14', NULL, NULL),
(23, '13', '24', 'TF4', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-11-14', '2019-11-16', 3, 'Intra-entreprise', 'Mediexperts', 'CANAL FOOD', 'Mounir BAZE', 1, 6, 0, 6, 0, 8000, 24000, 'VINGT-HUIT MILLE HUIT CENTS', 'annulé', 8, 13, NULL, '2020-09-18 04:55:36', '2020-12-25 14:41:09', NULL, NULL),
(24, '14', '25', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-10-24', '2019-10-26', 3, 'Intra-entreprise', 'Mediexperts', 'LES GRANDS MOULINS ZINE', 'Mounir BAZE', 1, 6, 6, 0, 0, 7000, 21000, NULL, 'réalisé', 12, 14, NULL, '2020-09-18 07:03:58', '2020-09-18 09:13:09', NULL, NULL),
(25, '15', '26', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-10-17', '2019-10-19', 3, 'Intra-entreprise', 'Mediexperts', 'LES GRANDS MOULINS ZINE', 'Mounir BAZE', 1, 6, 0, 6, 0, 7000, 21000, NULL, 'réalisé', 11, 14, NULL, '2020-09-18 08:30:22', '2020-09-18 09:13:37', NULL, NULL),
(26, '12', '27', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-10-24', '2019-10-26', 3, 'Intra-entreprise', 'Mediexperts', 'TRANSDINE', 'Mounir BAZE', 1, 6, 1, 5, 0, 7000, 21000, NULL, 'réalisé', 14, 15, NULL, '2020-09-18 10:05:57', '2020-09-18 10:05:57', NULL, NULL),
(27, '15', '26', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-10-17', '2019-10-19', 3, 'Intra-entreprise', 'Mediexperts', 'TRANSDINE', 'Mounir BAZE', 1, 6, 0, 6, 0, 7000, 21000, 'vingt-cinq mille deux cents', 'réalisé', 3, 15, NULL, '2020-09-18 10:07:59', '2020-11-13 07:47:25', NULL, NULL),
(31, '11', '30', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-10-22', '2019-10-23', 2, 'Intra-entreprise', 'Mediexperts', 'SALES UPLIFT', 'Adil RAISS EL FENNI', 1, 6, 6, 0, 0, 7000, 14000, 'SEIZE MILLE HUIT CENTS', 'réalisé', 19, 17, NULL, '2020-09-23 04:43:31', '2020-12-14 09:07:21', NULL, NULL),
(32, '16', '31', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-10-15', '2019-10-16', 2, 'Intra-entreprise', 'Mediexperts', 'SALES UPLIFT', 'Adil RAISS EL FENNI', 1, 5, 5, 0, 0, 7000, 14000, NULL, 'réalisé', 6, 17, NULL, '2020-09-23 04:44:59', '2020-09-23 04:44:59', NULL, NULL),
(33, '10', '32', 'TF3', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-11-26', '2019-11-27', 2, 'Intra-entreprise', 'Mediexperts', 'SALES UPLIFT', 'Adil RAISS EL FENNI', 1, 6, 6, 0, 0, 7000, 14000, NULL, 'réalisé', 1, 17, NULL, '2020-09-23 04:49:03', '2020-10-06 06:20:43', NULL, NULL),
(37, '16', '29', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-10-24', '2019-10-26', 3, 'Intra-entreprise', 'Mediexperts', 'ZINE CAPITAL INVEST', 'Mounir BAZE', 1, 6, 6, 0, 0, 7000, 21000, NULL, 'réalisé', 1, 16, NULL, '2020-09-25 10:39:01', '2020-09-25 10:39:01', NULL, NULL),
(38, '10', '28', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-10-17', '2019-10-19', 3, 'Intra-entreprise', 'Mediexperts', 'ZINE CAPITAL INVEST', 'Mounir BAZE', 1, 6, 6, 0, 0, 7500, 22500, NULL, 'réalisé', 6, 16, NULL, '2020-09-25 10:59:15', '2020-09-25 10:59:15', NULL, NULL),
(39, '16', '39', 'TF1', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', 'préparé', '2020-11-12', '2020-11-21', 6, 'Intra-entreprise', 'Mediexperts', 'SA.GLOBAL', 'Nabila WARDI', 1, 6, 6, 0, 0, 7000, 42000, 'CINQUANTE MILLE QUATRE CENTS', 'réalisé', 6, 19, NULL, '2020-10-15 12:16:44', '2021-01-22 08:48:46', 6, NULL),
(41, '16', '31', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'préparé', 'non préparé', '2020-11-26', '2020-11-28', 3, 'Intra-entreprise', 'Mediexperts', 'SA.GLOBAL', 'Nabila WARDI', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 6, 19, NULL, '2020-10-15 12:25:17', '2021-01-22 08:49:02', 6, NULL),
(42, '18', '37', 'TF3', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'préparé', 'non préparé', '2020-11-09', '2020-12-02', 9, 'Intra-entreprise', 'Mediexperts', 'SA.GLOBAL', 'Nabila WARDI', 2, 12, 12, 0, 0, 5000, 22500, 'QUARANTE-NEUF MILLE CINQ CENTS', 'réalisé', 15, 19, NULL, '2020-10-15 12:39:02', '2021-01-22 08:49:22', 3, NULL),
(43, '18', '36', 'TF4', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-07', '2021-01-20', 14, 'Intra-entreprise', 'Mediexperts', 'SA.GLOBAL', 'Nabila WARDI', 2, 12, 12, 0, 0, 5000, 35000, 'SOIXANTE-DIX-SEPT MILLE', 'réalisé', 16, 19, 'A modifier intervenant', '2020-10-15 12:58:50', '2021-01-22 08:49:39', 3, NULL),
(44, '15', '38', 'TF5', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'préparé', 'non préparé', '2020-12-03', '2020-12-05', 3, 'Intra-entreprise', 'Mediexperts', 'SA.GLOBAL', 'Nabila WARDI', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 17, 19, 'A vérifier intervenant', '2020-10-15 13:09:51', '2021-01-22 08:49:56', 6, NULL),
(45, '20', '52', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'préparé', 'préparé', '2020-11-19', '2020-11-21', 3, 'Intra-entreprise', 'Mediexperts', 'SCRH Group', 'FAHS MOHAMED', 1, 5, 1, 3, 1, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 2, 21, NULL, '2020-10-20 12:36:09', '2020-12-31 11:14:08', 6, NULL),
(46, '13', '24', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-11-26', '2020-11-28', 3, 'Intra-entreprise', 'Mediexperts', 'SCRH Group', 'FAHS MOHAMED', 1, 5, 5, 0, 0, 8000, 24000, 'VINGT-HUIT MILLE HUIT CENTS', 'réalisé', 8, 21, NULL, '2020-10-20 12:39:35', '2020-12-31 11:14:36', 6, NULL),
(47, '19', '45', 'TF3', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-03', '2020-12-05', 3, 'Intra-entreprise', 'Mediexperts', 'SCRH Group', 'FAHS MOHAMED', 1, 5, 2, 3, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 16, 21, NULL, '2020-10-20 12:42:45', '2020-12-31 11:14:54', 6, NULL),
(48, '11', '46', 'TF4', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-10', '2020-12-12', 3, 'Intra-entreprise', 'Mediexperts', 'SCRH Group', 'FAHS MOHAMED', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 6, 21, NULL, '2020-10-20 12:44:21', '2020-12-31 11:15:22', 6, NULL),
(49, '20', '47', 'TF5', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-17', '2020-12-19', 3, 'Intra-entreprise', 'Mediexperts', 'SCRH Group', 'FAHS MOHAMED', 1, 5, 2, 3, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 2, 21, NULL, '2020-10-20 12:45:34', '2020-12-31 11:15:45', 6, NULL),
(50, '10', '41', 'TF6', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-24', '2020-12-26', 3, 'Intra-entreprise', 'Mediexperts', 'SCRH Group', 'FAHS MOHAMED', 1, 5, 5, 0, 0, 7500, 22500, 'VINGT-SEPT MILLE', 'réalisé', 1, 21, NULL, '2020-10-20 12:46:57', '2020-12-31 11:16:17', 6, NULL),
(51, '16', '48', 'TF7', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-07', '2021-01-09', 3, 'Intra-entreprise', 'Mediexperts', 'SCRH Group', 'FAHS MOHAMED', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 8, 21, NULL, '2020-10-20 12:49:01', '2020-12-31 11:16:52', 6, NULL),
(52, '10', '49', 'TF8', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-14', '2021-01-16', 3, 'Intra-entreprise', 'Mediexperts', 'SCRH Group', 'FAHS MOHAMED', 1, 5, 5, 0, 0, 7500, 22500, 'VINGT-SEPT MILLE', 'réalisé', 1, 21, NULL, '2020-10-20 12:50:42', '2021-01-22 09:23:34', 6, NULL),
(53, '13', '50', 'TF9', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-21', '2021-01-23', 3, 'Intra-entreprise', 'Mediexperts', 'SCRH Group', 'FAHS MOHAMED', 1, 5, 5, 0, 0, 8000, 24000, 'VINGT-HUIT MILLE HUIT CENTS', 'réalisé', 1, 21, NULL, '2020-10-20 13:19:33', '2020-12-31 11:18:40', 6, NULL),
(54, '10', '51', 'TF10', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-28', '2021-01-30', 3, 'Intra-entreprise', 'Mediexperts', 'SCRH Group', 'FAHS MOHAMED', 1, 5, 5, 0, 0, 7500, 22500, 'VINGT-SEPT MILLE', 'réalisé', 1, 21, NULL, '2020-10-20 13:20:36', '2020-12-31 11:19:14', 6, NULL),
(55, '10', '40', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-11-19', '2020-11-21', 3, 'Intra-entreprise', 'Mediexperts', 'Hava Hard Trade', 'Belaid OUJANA', 1, 5, 5, 0, 0, 7500, 22500, 'VINGT-SEPT MILLE', 'réalisé', 1, 20, 'A modifie intervenant', '2020-10-20 14:13:47', '2021-01-22 08:58:11', 6, NULL),
(56, '10', '41', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-11-26', '2020-11-28', 3, 'Intra-entreprise', 'Mediexperts', 'Hava Hard Trade', 'Belaid OUJANA', 1, 5, 5, 0, 0, 7500, 22500, 'VINGT-SEPT MILLE', 'réalisé', 1, 20, 'A modifie intervenant', '2020-10-20 14:14:52', '2021-01-22 08:58:20', 6, NULL),
(57, '11', '22', 'TF3', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-04', '2020-12-05', 2, 'Intra-entreprise', 'Mediexperts', 'Hava Hard Trade', 'Belaid OUJANA', 1, 5, 5, 0, 0, 7000, 14000, 'SEIZE MILLE HUIT CENTS', 'réalisé', 1, 20, 'A modifie intervenant', '2020-10-20 14:15:45', '2021-01-22 08:58:29', 6, NULL),
(58, '11', '42', 'TF4', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-10', '2020-12-12', 3, 'Intra-entreprise', 'Mediexperts', 'Hava Hard Trade', 'Belaid OUJANA', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 1, 20, 'A modifie intervenant', '2020-10-20 14:17:28', '2021-01-22 08:58:38', 6, NULL),
(59, '11', '43', 'TF5', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-17', '2020-12-19', 3, 'Intra-entreprise', 'Mediexperts', 'Hava Hard Trade', 'Belaid OUJANA', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 1, 20, 'A modifie intervenant', '2020-10-20 14:19:00', '2021-01-22 08:58:50', 6, NULL),
(60, '11', '42', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-11-19', '2020-11-20', 2, 'Intra-entreprise', 'Mediexperts', 'MAROC TISSUS PLASTIFIES', 'MEHDI MIYARA', 1, 5, 5, 0, 0, 7000, 14000, 'SEIZE MILLE HUIT CENTS', 'réalisé', 8, 22, NULL, '2020-10-21 11:58:34', '2020-12-31 11:27:00', 6, NULL),
(61, '16', '53', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-11-21', '2020-11-26', 2, 'Intra-entreprise', 'Mediexperts', 'MAROC TISSUS PLASTIFIES', 'MEHDI MIYARA', 1, 5, 5, 0, 0, 7000, 14000, 'SEIZE MILLE HUIT CENTS', 'réalisé', 8, 22, NULL, '2020-10-21 12:00:51', '2020-12-31 11:27:26', 6, NULL),
(62, '10', '32', 'TF3', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-11-27', '2020-11-28', 2, 'Intra-entreprise', 'Mediexperts', 'MAROC TISSUS PLASTIFIES', 'MEHDI MIYARA', 1, 5, 5, 0, 0, 7500, 15000, 'DIX-HUIT MILLE', 'réalisé', 8, 22, NULL, '2020-10-21 12:01:52', '2020-12-31 11:27:53', 6, NULL),
(63, '20', '57', 'TF4', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-03', '2020-12-03', 1, 'Intra-entreprise', 'Mediexperts', 'MAROC TISSUS PLASTIFIES', 'MEHDI MIYARA', 1, 6, 0, 0, 6, 7000, 7000, 'HUIT MILLE QUATRE CENTS', 'réalisé', 8, 22, NULL, '2020-10-21 12:06:35', '2020-12-31 11:28:50', 6, NULL),
(64, '13', '50', 'TF5', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-04', '2020-12-05', 2, 'Intra-entreprise', 'Mediexperts', 'MAROC TISSUS PLASTIFIES', 'MEHDI MIYARA', 1, 5, 5, 0, 0, 8000, 16000, 'DIX-NEUF MILLE DEUX CENTS', 'réalisé', 8, 22, NULL, '2020-10-21 12:09:44', '2020-12-31 11:29:11', 6, NULL),
(65, '10', '55', 'TF6', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-10', '2020-12-11', 2, 'Intra-entreprise', 'Mediexperts', 'MAROC TISSUS PLASTIFIES', 'MEHDI MIYARA', 1, 5, 5, 0, 0, 7500, 15000, 'DIX-HUIT MILLE', 'réalisé', 8, 22, NULL, '2020-10-21 12:11:43', '2020-12-31 11:30:33', 6, NULL),
(66, '14', '56', 'TF7', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-12', '2020-12-17', 2, 'Intra-entreprise', 'Mediexperts', 'MAROC TISSUS PLASTIFIES', 'MEHDI MIYARA', 1, 5, 5, 0, 0, 7000, 14000, 'SEIZE MILLE HUIT CENTS', 'réalisé', 8, 22, NULL, '2020-10-21 12:13:18', '2020-12-31 11:34:37', 6, NULL),
(67, '14', '58', 'TF8', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-18', '2020-12-18', 1, 'Intra-entreprise', 'Mediexperts', 'MAROC TISSUS PLASTIFIES', 'MEHDI MIYARA', 1, 5, 5, 0, 0, 7000, 7000, 'HUIT MILLE QUATRE CENTS', 'réalisé', 8, 22, NULL, '2020-10-21 12:20:04', '2020-12-31 11:35:15', 6, NULL),
(68, '12', '23', 'TF9', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-19', '2020-12-24', 2, 'Intra-entreprise', 'Mediexperts', 'MAROC TISSUS PLASTIFIES', 'MEHDI MIYARA', 1, 6, 6, 0, 0, 7000, 14000, 'SEIZE MILLE HUIT CENTS', 'réalisé', 8, 22, NULL, '2020-10-21 12:22:24', '2020-12-31 11:36:00', 6, NULL),
(69, '10', '40', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-11-19', '2020-11-21', 3, 'Intra-entreprise', 'Mediexperts', 'BURINTEL S.A', 'Nourdin EL HAJAMI', 1, 6, 6, 0, 0, 7500, 22500, 'VINGT-SEPT MILLE', 'réalisé', 6, 23, NULL, '2020-10-21 13:41:20', '2021-01-22 09:07:10', 6, NULL),
(70, '10', '59', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-11-26', '2020-11-28', 3, 'Intra-entreprise', 'Mediexperts', 'BURINTEL S.A', 'Nourdin EL HAJAMI', 1, 6, 6, 0, 0, 7500, 22500, 'VINGT-SEPT MILLE', 'réalisé', 6, 23, NULL, '2020-10-21 13:48:20', '2021-01-22 09:07:25', 6, NULL),
(71, '10', '41', 'TF3', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-03', '2020-12-05', 3, 'Intra-entreprise', 'Mediexperts', 'BURINTEL S.A', 'Nourdin EL HAJAMI', 1, 6, 6, 0, 0, 7500, 22500, 'VINGT-SEPT MILLE', 'réalisé', 6, 23, NULL, '2020-10-21 13:50:30', '2021-01-22 09:07:34', 6, NULL),
(72, '14', '58', 'TF4', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-10', '2020-12-11', 2, 'Intra-entreprise', 'Mediexperts', 'BURINTEL S.A', 'Nourdin EL HAJAMI', 1, 6, 6, 0, 0, 7000, 14000, 'SEIZE MILLE HUIT CENTS', 'réalisé', 6, 23, NULL, '2020-10-21 13:51:35', '2021-01-22 09:03:26', 6, NULL),
(73, '10', '55', 'TF5', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-12', '2020-12-18', 3, 'Intra-entreprise', 'Mediexperts', 'BURINTEL S.A', 'Nourdin EL HAJAMI', 1, 6, 6, 0, 0, 7500, 22500, 'VINGT-SEPT MILLE', 'réalisé', 6, 23, NULL, '2020-10-21 13:53:23', '2021-01-22 09:07:45', 6, NULL),
(74, '15', '60', 'TF6', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-19', '2020-12-24', 2, 'Intra-entreprise', 'Mediexperts', 'BURINTEL S.A', 'Nourdin EL HAJAMI', 1, 6, 6, 0, 0, 7000, 14000, 'SEIZE MILLE HUIT CENTS', 'réalisé', 6, 23, NULL, '2020-10-21 14:01:57', '2021-01-22 09:07:53', 6, NULL),
(75, '16', '48', 'TF7', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-25', '2020-12-31', 3, 'Intra-entreprise', 'Mediexperts', 'BURINTEL S.A', 'Nourdin EL HAJAMI', 1, 6, 6, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 6, 23, NULL, '2020-10-21 14:04:32', '2021-01-22 09:08:01', 6, NULL),
(76, '13', '50', 'TF8', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-07', '2021-01-09', 3, 'Intra-entreprise', 'Mediexperts', 'BURINTEL S.A', 'Nourdin EL HAJAMI', 1, 6, 6, 0, 0, 8000, 24000, 'VINGT-HUIT MILLE HUIT CENTS', 'réalisé', 6, 23, NULL, '2020-10-21 14:06:00', '2021-01-22 09:04:34', 6, NULL),
(77, '16', '61', 'TF9', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-14', '2021-01-16', 3, 'Intra-entreprise', 'Mediexperts', 'BURINTEL S.A', 'Nourdin EL HAJAMI', 1, 6, 6, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 6, 23, NULL, '2020-10-21 14:09:31', '2021-01-22 09:05:41', 6, NULL),
(78, '11', '22', 'TF10', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-21', '2021-01-23', 3, 'Intra-entreprise', 'Mediexperts', 'BURINTEL S.A', 'Nourdin EL HAJAMI', 1, 6, 6, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 6, 23, NULL, '2020-10-21 14:10:49', '2021-01-22 09:06:04', 6, NULL),
(79, '11', '42', 'TF11', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-29', '2021-01-30', 2, 'Intra-entreprise', 'Mediexperts', 'BURINTEL S.A', 'Nourdin EL HAJAMI', 1, 6, 6, 0, 0, 7000, 14000, 'SEIZE MILLE HUIT CENTS', 'réalisé', 6, 23, NULL, '2020-10-21 14:12:21', '2021-01-22 09:06:18', 6, NULL),
(80, '11', '62', 'TF12', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-05', '2021-01-06', 2, 'Intra-entreprise', 'Mediexperts', 'BURINTEL S.A', 'Nourdin EL HAJAMI', 1, 6, 6, 0, 0, 7000, 14000, 'SEIZE MILLE HUIT CENTS', 'réalisé', 6, 23, NULL, '2020-10-21 14:16:00', '2021-01-22 09:06:28', 6, NULL),
(81, '11', '43', 'TF13', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-02-11', '2021-02-13', 3, 'Intra-entreprise', 'Mediexperts', 'BURINTEL S.A', 'Nourdin EL HAJAMI', 1, 6, 6, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 6, 23, NULL, '2020-10-21 14:17:30', '2021-01-22 09:06:37', 6, NULL),
(82, '12', '64', 'TF14', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-02-18', '2021-02-20', 3, 'Intra-entreprise', 'Mediexperts', 'BURINTEL S.A', 'Nourdin EL HAJAMI', 1, 6, 6, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 6, 23, NULL, '2020-10-21 14:22:57', '2021-01-22 09:06:45', 6, NULL),
(83, '16', '63', 'TF15', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-02-25', '2021-02-27', 3, 'Intra-entreprise', 'Mediexperts', 'BURINTEL S.A', 'Nourdin EL HAJAMI', 1, 6, 6, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 6, 23, NULL, '2020-10-21 14:24:15', '2021-01-22 09:06:55', 6, NULL),
(84, '13', '50', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-11-19', '2020-11-26', 4, 'Intra-entreprise', 'Mediexperts', 'SALES UPLIFT', 'Adil RAISS EL FENNI', 1, 5, 2, 3, 0, 8000, 32000, 'TRENTE-HUIT MILLE QUATRE CENTS', 'réalisé', 7, 24, 'A modifié l\'intervenant', '2020-10-22 05:57:10', '2021-01-22 08:55:31', 6, NULL),
(85, '10', '55', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-11-27', '2020-12-05', 5, 'Intra-entreprise', 'Mediexperts', 'SALES UPLIFT', 'Adil RAISS EL FENNI', 1, 5, 2, 3, 0, 7500, 37500, 'QUARANTE-CINQ MILLE', 'réalisé', 7, 24, NULL, '2020-10-22 05:58:25', '2021-01-22 08:55:39', 6, NULL),
(86, '10', '41', 'TF3', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-10', '2020-12-18', 5, 'Intra-entreprise', 'Mediexperts', 'SALES UPLIFT', 'Adil RAISS EL FENNI', 1, 5, 2, 3, 0, 7500, 37500, 'QUARANTE-CINQ MILLE', 'réalisé', 7, 24, NULL, '2020-10-22 05:59:21', '2021-01-22 08:55:47', 6, NULL),
(87, '11', '22', 'TF4', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-19', '2020-12-31', 5, 'Intra-entreprise', 'Mediexperts', 'SALES UPLIFT', 'Adil RAISS EL FENNI', 1, 5, 2, 3, 0, 7000, 35000, 'QUARANTE-DEUX MILLE', 'réalisé', 7, 24, NULL, '2020-10-22 06:00:03', '2021-01-22 08:55:57', 6, NULL),
(88, '11', '42', 'TF5', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-02', '2021-01-08', 3, 'Intra-entreprise', 'Mediexperts', 'SALES UPLIFT', 'Adil RAISS EL FENNI', 1, 5, 2, 3, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 7, 24, NULL, '2020-10-22 06:01:04', '2021-01-22 08:56:16', 6, NULL),
(89, '12', '65', 'TF6', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-09', '2021-01-21', 5, 'Intra-entreprise', 'Mediexperts', 'SALES UPLIFT', 'Adil RAISS EL FENNI', 1, 5, 2, 3, 0, 7000, 35000, 'QUARANTE-DEUX MILLE', 'réalisé', 7, 24, NULL, '2020-10-22 06:01:55', '2021-01-22 08:56:47', 6, NULL),
(90, '13', '66', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-11-19', '2020-11-21', 3, 'Intra-entreprise', 'Mediexperts', 'LES GRANDS MOULINS ZINE', 'Mounir BAZE', 1, 5, 5, 0, 0, 8000, 24000, 'VINGT-HUIT MILLE HUIT CENTS', 'réalisé', 3, 25, 'A modifié l\'intervenant', '2020-10-22 13:44:04', '2020-12-28 15:39:45', NULL, NULL),
(91, '11', '42', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-11-26', '2020-12-05', 5, 'Intra-entreprise', 'Mediexperts', 'LES GRANDS MOULINS ZINE', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 35000, 'QUARANTE-DEUX MILLE', 'réalisé', 3, 25, NULL, '2020-10-22 13:44:58', '2020-12-28 15:40:38', NULL, NULL),
(92, '12', '67', 'TF3', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-10', '2020-12-12', 3, 'Intra-entreprise', 'Mediexperts', 'LES GRANDS MOULINS ZINE', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 4, 25, NULL, '2020-10-22 13:46:17', '2020-12-28 15:41:26', NULL, NULL),
(93, '12', '68', 'TF4', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-17', '2020-12-19', 3, 'Intra-entreprise', 'Mediexperts', 'LES GRANDS MOULINS ZINE', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 3, 25, NULL, '2020-10-22 13:47:03', '2020-12-28 15:42:03', NULL, NULL),
(94, '10', '21', 'TF5', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-24', '2020-12-26', 3, 'Intra-entreprise', 'Mediexperts', 'LES GRANDS MOULINS ZINE', 'Mounir BAZE', 1, 5, 5, 0, 0, 7500, 22500, 'VINGT-SEPT MILLE', 'réalisé', 3, 25, NULL, '2020-10-22 13:48:10', '2020-12-28 15:43:14', NULL, NULL),
(96, '7', '69', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-11-19', '2020-11-28', 5, 'Intra-entreprise', 'Mediexperts', 'ZINE CEREALES', 'Mounir BAZE', 1, 5, 5, 0, 0, 6000, 30000, 'TRENTE-SIX MILLE', 'réalisé', 9, 26, 'A modifié l\'intervenant', '2020-10-23 06:44:29', '2020-12-28 15:52:56', NULL, NULL),
(97, '9', '70', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-03', '2020-12-05', 3, 'Intra-entreprise', 'Mediexperts', 'ZINE CEREALES', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 9, 26, NULL, '2020-10-23 06:45:17', '2020-12-28 15:53:29', NULL, NULL),
(98, '4', '71', 'TF3', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-10', '2020-12-12', 3, 'Intra-entreprise', 'Mediexperts', 'ZINE CEREALES', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 9, 26, NULL, '2020-10-23 06:46:02', '2020-12-28 15:54:22', NULL, NULL),
(99, '8', '12', 'TF4', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-17', '2020-12-26', 5, 'Intra-entreprise', 'Mediexperts', 'ZINE CEREALES', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 35000, 'QUARANTE-DEUX MILLE', 'réalisé', 9, 26, NULL, '2020-10-23 06:47:07', '2020-12-28 15:55:13', NULL, NULL),
(100, '6', '72', 'TF5', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-07', '2021-01-09', 3, 'Intra-entreprise', 'Mediexperts', 'ZINE CEREALES', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 9, 26, NULL, '2020-10-23 06:48:02', '2021-01-21 15:42:28', 6, NULL),
(101, '6', '79', 'TF6', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-14', '2021-01-16', 3, 'Intra-entreprise', 'Mediexperts', 'ZINE CEREALES', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 9, 26, NULL, '2020-10-23 06:48:45', '2021-01-21 15:43:01', 6, NULL),
(102, '6', '73', 'TF7', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-21', '2021-01-28', 4, 'Intra-entreprise', 'Mediexperts', 'ZINE CEREALES', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 28000, 'TRENTE-TROIS MILLE SIX CENTS', 'réalisé', 9, 26, NULL, '2020-10-23 06:49:41', '2021-01-21 15:43:14', 6, NULL),
(103, '3', '74', 'TF8', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-29', '2021-02-05', 4, 'Intra-entreprise', 'Mediexperts', 'ZINE CEREALES', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 28000, 'TRENTE-TROIS MILLE SIX CENTS', 'réalisé', 9, 26, NULL, '2020-10-23 06:50:30', '2021-01-21 15:43:26', 6, NULL),
(104, '4', '20', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-11-19', '2020-11-28', 5, 'Intra-entreprise', 'Mediexperts', 'COMPLEXE ALIMENTAIRE ZINE', 'Mounir BAZE', 1, 5, 3, 2, 0, 7000, 35000, 'QUARANTE-DEUX MILLE', 'réalisé', 11, 27, 'A modifié l\'intervenant', '2020-10-23 08:40:40', '2020-12-28 16:08:24', NULL, NULL),
(105, '9', '70', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-03', '2020-12-05', 3, 'Intra-entreprise', 'Mediexperts', 'COMPLEXE ALIMENTAIRE ZINE', 'Mounir BAZE', 1, 5, 3, 2, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 11, 27, NULL, '2020-10-23 08:41:31', '2020-12-28 16:09:07', NULL, NULL),
(106, '4', '10', 'TF3', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-10', '2020-12-12', 3, 'Intra-entreprise', 'Mediexperts', 'COMPLEXE ALIMENTAIRE ZINE', 'Mounir BAZE', 1, 5, 2, 3, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 11, 27, NULL, '2020-10-23 08:42:23', '2020-12-28 16:10:51', NULL, NULL),
(107, '6', '15', 'TF4', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-17', '2020-12-26', 5, 'Intra-entreprise', 'Mediexperts', 'COMPLEXE ALIMENTAIRE ZINE', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 35000, 'QUARANTE-DEUX MILLE', 'réalisé', 11, 27, NULL, '2020-10-23 08:43:14', '2020-12-28 16:12:08', NULL, NULL),
(108, '6', '72', 'TF5', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-07', '2021-01-09', 3, 'Intra-entreprise', 'Mediexperts', 'COMPLEXE ALIMENTAIRE ZINE', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 21000, NULL, 'réalisé', 11, 27, NULL, '2020-10-23 08:44:03', '2020-10-23 08:44:03', NULL, NULL),
(109, '6', '79', 'TF6', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-14', '2021-01-16', 3, 'Intra-entreprise', 'Mediexperts', 'COMPLEXE ALIMENTAIRE ZINE', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 21000, NULL, 'réalisé', 11, 27, NULL, '2020-10-23 08:44:53', '2020-10-23 08:44:53', NULL, NULL),
(110, '6', '73', 'TF7', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-21', '2021-01-23', 3, 'Intra-entreprise', 'Mediexperts', 'COMPLEXE ALIMENTAIRE ZINE', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 21000, NULL, 'réalisé', 11, 27, NULL, '2020-10-23 08:45:37', '2020-10-23 08:45:37', NULL, NULL),
(111, '3', '74', 'TF8', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-28', '2021-01-30', 3, 'Intra-entreprise', 'Mediexperts', 'COMPLEXE ALIMENTAIRE ZINE', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 21000, NULL, 'réalisé', 11, 27, NULL, '2020-10-23 08:46:16', '2020-10-23 08:46:16', NULL, NULL),
(112, '4', '75', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-11-19', '2020-11-28', 5, 'Intra-entreprise', 'Mediexperts', 'Biscuiterie Moderne Zine', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 35000, 'QUARANTE-DEUX MILLE', 'réalisé', 1, 28, NULL, '2020-10-23 09:49:01', '2020-12-29 08:47:42', NULL, NULL),
(113, '34', '138', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-03', '2020-12-05', 3, 'Intra-entreprise', 'Mediexperts', 'Biscuiterie Moderne Zine', 'Mounir BAZE', 1, 5, 3, 2, 0, 6000, 18000, 'VINGT-ET-UN MILLE SIX CENTS', 'réalisé', 1, 28, 'Le montant facturé et comptabilisé : 21000', '2020-10-23 09:49:52', '2021-03-31 10:54:30', 6, NULL),
(114, '4', '10', 'TF3', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-10', '2020-12-12', 3, 'Intra-entreprise', 'Mediexperts', 'Biscuiterie Moderne Zine', 'Mounir BAZE', 1, 5, 3, 2, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 1, 28, NULL, '2020-10-23 09:50:44', '2020-12-29 08:49:31', NULL, NULL),
(115, '6', '78', 'TF4', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-17', '2020-12-26', 5, 'Intra-entreprise', 'Mediexperts', 'Biscuiterie Moderne Zine', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 35000, 'QUARANTE-DEUX MILLE', 'réalisé', 1, 28, NULL, '2020-10-23 09:51:39', '2020-12-29 08:50:14', NULL, NULL),
(116, '9', '70', 'TF5', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-31', '2021-01-09', 4, 'Intra-entreprise', 'Mediexperts', 'Biscuiterie Moderne Zine', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 28000, 'TRENTE-TROIS MILLE SIX CENTS', 'réalisé', 1, 28, NULL, '2020-10-23 09:52:50', '2021-01-21 15:18:52', 6, NULL),
(117, '6', '79', 'TF6', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-14', '2021-01-16', 3, 'Intra-entreprise', 'Mediexperts', 'Biscuiterie Moderne Zine', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 1, 28, NULL, '2020-10-23 09:53:36', '2021-01-21 15:14:33', 6, NULL),
(118, '6', '73', 'TF7', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-21', '2021-01-23', 3, 'Intra-entreprise', 'Mediexperts', 'Biscuiterie Moderne Zine', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 1, 28, NULL, '2020-10-23 09:54:24', '2021-01-21 15:14:47', 6, NULL),
(119, '3', '74', 'TF8', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-28', '2021-02-04', 4, 'Intra-entreprise', 'Mediexperts', 'Biscuiterie Moderne Zine', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 28000, 'TRENTE-TROIS MILLE SIX CENTS', 'réalisé', 1, 28, NULL, '2020-10-23 09:55:30', '2021-01-21 15:15:00', 6, NULL),
(120, '3', '80', 'TF9', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-02-05', '2021-02-13', 5, 'Intra-entreprise', 'Mediexperts', 'Biscuiterie Moderne Zine', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 35000, 'QUARANTE-DEUX MILLE', 'réalisé', 1, 28, NULL, '2020-10-23 09:57:39', '2021-01-21 15:15:13', 6, NULL),
(121, '4', '71', 'TF10', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-02-18', '2021-02-27', 5, 'Intra-entreprise', 'Mediexperts', 'Biscuiterie Moderne Zine', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 35000, 'QUARANTE-DEUX MILLE', 'réalisé', 1, 28, NULL, '2020-10-23 10:00:36', '2021-01-21 15:15:29', 6, NULL),
(122, '22', '76', 'TF11', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-03-04', '2021-03-06', 3, 'Intra-entreprise', 'Mediexperts', 'Biscuiterie Moderne Zine', 'Mounir BAZE', 1, 5, 5, 0, 0, 6000, 18000, 'VINGT-ET-UN MILLE SIX CENTS', 'réalisé', 1, 28, NULL, '2020-10-23 10:01:18', '2021-01-21 15:15:41', 6, NULL),
(123, '3', '82', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-11-19', '2020-11-28', 5, 'Intra-entreprise', 'Mediexperts', 'LES GRANDES SEMOULERIES ZINE', 'BAZE MOUNIR', 1, 5, 5, 0, 0, 7000, 35000, 'QUARANTE-DEUX MILLE', 'réalisé', 2, 29, 'A modifié l\'intervenant', '2020-10-23 10:20:27', '2020-12-29 07:32:28', NULL, NULL),
(124, '23', '83', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-03', '2020-12-05', 3, 'Intra-entreprise', 'Mediexperts', 'LES GRANDES SEMOULERIES ZINE', 'BAZE MOUNIR', 1, 5, 2, 3, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 2, 29, NULL, '2020-10-23 10:23:06', '2020-12-29 07:33:24', NULL, NULL),
(125, '6', '81', 'TF3', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-10', '2020-12-12', 3, 'Intra-entreprise', 'Mediexperts', 'LES GRANDES SEMOULERIES ZINE', 'BAZE MOUNIR', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 2, 29, NULL, '2020-10-23 10:23:45', '2020-12-29 07:33:54', NULL, NULL),
(126, '6', '15', 'TF4', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-17', '2020-12-26', 5, 'Intra-entreprise', 'Mediexperts', 'LES GRANDES SEMOULERIES ZINE', 'BAZE MOUNIR', 1, 5, 5, 0, 0, 7000, 35000, 'QUARANTE-DEUX MILLE', 'réalisé', 2, 29, NULL, '2020-10-23 10:24:36', '2020-12-29 07:34:31', NULL, NULL),
(127, '6', '72', 'TF5', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-07', '2021-01-09', 3, 'Intra-entreprise', 'Mediexperts', 'LES GRANDES SEMOULERIES ZINE', 'BAZE MOUNIR', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 1, 29, NULL, '2020-10-23 10:25:17', '2021-01-22 08:28:58', 6, NULL),
(128, '6', '79', 'TF6', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-14', '2021-01-16', 3, 'Intra-entreprise', 'Mediexperts', 'LES GRANDES SEMOULERIES ZINE', 'BAZE MOUNIR', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 2, 29, NULL, '2020-10-23 10:26:10', '2021-01-22 08:29:20', 6, NULL),
(129, '6', '73', 'TF7', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-21', '2021-01-23', 3, 'Intra-entreprise', 'Mediexperts', 'LES GRANDES SEMOULERIES ZINE', 'BAZE MOUNIR', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 2, 29, NULL, '2020-10-23 10:26:55', '2021-01-22 08:29:32', 6, NULL),
(130, '3', '74', 'TF8', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-28', '2021-01-30', 3, 'Intra-entreprise', 'Mediexperts', 'LES GRANDES SEMOULERIES ZINE', 'BAZE MOUNIR', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 2, 29, NULL, '2020-10-23 10:27:33', '2021-01-22 08:30:05', 6, NULL),
(131, '10', '84', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-11-19', '2020-11-28', 6, 'Intra-entreprise', 'Mediexperts', 'CANAL FOOD', 'Mounir BAZE', 1, 5, 5, 0, 0, 7500, 45000, 'CINQUANTE-QUATRE MILLE', 'réalisé', 7, 30, 'A modifié l\'intervenant', '2020-10-23 12:14:56', '2020-12-28 15:11:33', NULL, NULL),
(132, '10', '55', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-03', '2020-12-12', 6, 'Intra-entreprise', 'Mediexperts', 'CANAL FOOD', 'Mounir BAZE', 1, 5, 5, 0, 0, 7500, 45000, 'CINQUANTE-QUATRE MILLE', 'réalisé', 7, 30, NULL, '2020-10-23 12:15:47', '2020-12-28 15:17:00', NULL, NULL),
(133, '20', '52', 'TF3', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-17', '2020-12-19', 3, 'Intra-entreprise', 'Mediexperts', 'CANAL FOOD', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 7, 30, NULL, '2020-10-23 12:16:35', '2020-12-28 15:13:04', NULL, NULL),
(134, '12', '85', 'TF4', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-24', '2020-12-26', 3, 'Intra-entreprise', 'Mediexperts', 'CANAL FOOD', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 7, 30, NULL, '2020-10-23 12:19:32', '2020-12-28 15:13:31', NULL, NULL),
(135, '12', '64', 'TF5', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-07', '2021-01-16', 6, 'Intra-entreprise', 'Mediexperts', 'CANAL FOOD', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 42000, 'CINQUANTE MILLE QUATRE CENTS', 'réalisé', 7, 30, NULL, '2020-10-23 12:21:07', '2021-01-21 11:20:03', 6, NULL),
(136, '12', '67', 'TF6', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-21', '2021-01-30', 6, 'Intra-entreprise', 'Mediexperts', 'CANAL FOOD', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 42000, 'CINQUANTE MILLE QUATRE CENTS', 'réalisé', 7, 30, NULL, '2020-10-23 12:21:49', '2021-01-21 11:20:14', 6, NULL),
(137, '12', '86', 'TF7', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-02-04', '2021-02-06', 3, 'Intra-entreprise', 'Mediexperts', 'CANAL FOOD', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 7, 30, NULL, '2020-10-23 12:24:14', '2021-01-21 11:20:30', 6, NULL),
(138, '12', '68', 'TF8', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-02-11', '2021-02-13', 3, 'Intra-entreprise', 'Mediexperts', 'CANAL FOOD', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 7, 30, NULL, '2020-10-23 12:25:22', '2021-01-21 11:20:43', 6, NULL),
(139, '24', '87', 'TF9', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-02-18', '2021-02-20', 3, 'Intra-entreprise', 'Mediexperts', 'CANAL FOOD', 'Mounir BAZE', 1, 5, 5, 0, 0, 5000, 15000, 'DIX-HUIT MILLE', 'réalisé', 7, 30, NULL, '2020-10-23 12:29:20', '2021-01-21 11:21:32', 6, NULL),
(140, '19', '88', 'TF10', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-02-25', '2021-03-04', 4, 'Intra-entreprise', 'Mediexperts', 'CANAL FOOD', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 28000, 'TRENTE-TROIS MILLE SIX CENTS', 'réalisé', 7, 30, NULL, '2020-10-23 12:31:22', '2021-01-21 11:22:58', 6, NULL),
(141, '15', '89', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-11-19', '2020-11-26', 4, 'Intra-entreprise', 'Mediexperts', 'TRANSDINE', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 28000, 'TRENTE-TROIS MILLE SIX CENTS', 'planifié', 1, 31, 'A modifié l\'intervenant', '2020-10-23 14:21:12', '2020-12-28 14:52:44', NULL, NULL),
(142, '15', '90', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-11-27', '2020-12-04', 4, 'Intra-entreprise', 'Mediexperts', 'TRANSDINE', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 28000, 'TRENTE-TROIS MILLE SIX CENTS', 'planifié', 1, 31, NULL, '2020-10-23 14:21:54', '2020-12-28 14:54:00', NULL, NULL),
(143, '15', '91', 'TF3', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-05', '2020-12-12', 4, 'Intra-entreprise', 'Mediexperts', 'TRANSDINE', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 28000, 'TRENTE-TROIS MILLE SIX CENTS', 'planifié', 1, 31, NULL, '2020-10-23 14:22:35', '2020-12-28 14:54:58', NULL, NULL),
(144, '15', '92', 'TF4', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-17', '2020-12-24', 4, 'Intra-entreprise', 'Mediexperts', 'TRANSDINE', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 28000, 'TRENTE-TROIS MILLE SIX CENTS', 'planifié', 1, 31, NULL, '2020-10-23 14:23:19', '2020-12-28 14:55:45', NULL, NULL),
(145, '15', '93', 'TF5', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-25', '2021-01-07', 4, 'Intra-entreprise', 'Mediexperts', 'TRANSDINE', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 28000, 'TRENTE-TROIS MILLE SIX CENTS', 'planifié', 1, 31, NULL, '2020-10-23 14:24:08', '2021-01-21 10:46:11', 6, NULL),
(146, '15', '94', 'TF6', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-08', '2021-01-16', 4, 'Intra-entreprise', 'Mediexperts', 'TRANSDINE', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 28000, 'TRENTE-TROIS MILLE SIX CENTS', 'planifié', 1, 31, NULL, '2020-10-23 14:24:47', '2021-01-21 10:47:00', 6, NULL),
(147, '15', '95', 'TF7', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-21', '2021-01-30', 6, 'Intra-entreprise', 'Mediexperts', 'TRANSDINE', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 42000, 'CINQUANTE MILLE QUATRE CENTS', 'planifié', 1, 31, NULL, '2020-10-23 14:25:36', '2021-01-21 10:47:15', 6, NULL),
(148, '15', '96', 'TF8', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-02-04', '2021-02-13', 6, 'Intra-entreprise', 'Mediexperts', 'TRANSDINE', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 42000, 'CINQUANTE MILLE QUATRE CENTS', 'planifié', 1, 31, NULL, '2020-10-23 14:26:22', '2021-01-21 10:47:32', 6, NULL),
(149, '15', '98', 'TF9', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-02-18', '2021-02-27', 6, 'Intra-entreprise', 'Mediexperts', 'TRANSDINE', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 42000, 'CINQUANTE MILLE QUATRE CENTS', 'planifié', 1, 31, NULL, '2020-10-23 14:29:06', '2021-01-21 10:47:57', 6, NULL),
(150, '15', '97', 'TF10', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-03-04', '2021-03-13', 6, 'Intra-entreprise', 'Mediexperts', 'TRANSDINE', 'Mounir BAZE', 1, 5, 5, 0, 0, 7000, 42000, 'CINQUANTE MILLE QUATRE CENTS', 'planifié', 1, 31, NULL, '2020-10-23 14:29:56', '2021-01-21 10:48:12', 6, NULL),
(151, '26', '99', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-11-19', '2020-11-20', 2, 'Intra-entreprise', 'Mediexperts', 'LEADER FOOD', 'Ahmed BOUDRAA', 1, 6, 6, 0, 0, 5000, 10000, 'DOUZE MILLE', 'réalisé', 1, 32, 'A modifé l\'intervenant', '2020-11-02 07:43:41', '2021-01-22 09:27:36', 6, NULL),
(152, '14', '128', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-11-21', '2020-11-26', 2, 'Intra-entreprise', 'Mediexperts', 'LEADER FOOD', 'Ahmed BOUDRAA', 1, 5, 0, 5, 0, 7000, 14000, 'SEIZE MILLE HUIT CENTS', 'réalisé', 1, 32, NULL, '2020-11-02 07:45:15', '2021-01-22 09:27:42', 6, NULL);
INSERT INTO `plan_formations` (`n_form`, `id_dom`, `id_thm`, `n_action`, `model5`, `model3`, `f4`, `fiche_eval`, `support_form`, `cv_inv`, `avis_affich`, `dt_debut`, `dt_fin`, `nb_jour`, `type_form`, `organisme`, `lieu`, `nom_resp`, `nb_grp`, `nb_partcp_total`, `nb_cadre`, `nb_employe`, `nb_ouvrier`, `bdg_jour`, `bdg_total`, `bdg_letter`, `etat`, `id_inv`, `id_plan`, `commentaire`, `created_at`, `updated_at`, `nb_heure`, `at_approb_ds`) VALUES
(153, '16', '101', 'TF3', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-11-27', '2020-11-28', 2, 'Intra-entreprise', 'Mediexperts', 'LEADER FOOD', 'Ahmed BOUDRAA', 1, 5, 5, 0, 0, 7000, 14000, 'SEIZE MILLE HUIT CENTS', 'réalisé', 1, 32, NULL, '2020-11-02 07:46:08', '2021-01-22 09:27:49', 6, NULL),
(154, '28', '102', 'TF4', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-03', '2020-12-03', 1, 'Intra-entreprise', 'Mediexperts', 'LEADER FOOD', 'Ahmed BOUDRAA', 1, 6, 6, 0, 0, 7000, 7000, 'HUIT MILLE QUATRE CENTS', 'réalisé', 1, 32, NULL, '2020-11-02 07:47:17', '2021-01-22 09:27:56', 6, NULL),
(155, '31', '103', 'TF5', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-05', '2020-12-11', 3, 'Intra-entreprise', 'Mediexperts', 'LEADER FOOD', 'Ahmed BOUDRAA', 1, 6, 6, 0, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 18, 32, NULL, '2020-11-02 07:48:10', '2021-02-01 14:14:34', 6, NULL),
(156, '11', '104', 'TF6', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-12', '2020-12-12', 1, 'Intra-entreprise', 'Mediexperts', 'LEADER FOOD', 'Ahmed BOUDRAA', 1, 6, 6, 0, 0, 7000, 7000, 'HUIT MILLE QUATRE CENTS', 'réalisé', 1, 32, NULL, '2020-11-02 07:49:03', '2021-01-22 09:28:10', 6, NULL),
(157, '11', '105', 'TF7', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-17', '2020-12-17', 1, 'Intra-entreprise', 'Mediexperts', 'LEADER FOOD', 'Ahmed BOUDRAA', 1, 6, 6, 0, 0, 7000, 7000, 'HUIT MILLE QUATRE CENTS', 'réalisé', 1, 32, NULL, '2020-11-02 07:53:25', '2021-01-22 09:28:20', 6, NULL),
(158, '14', '129', 'TF8', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-18', '2020-12-18', 1, 'Intra-entreprise', 'Mediexperts', 'LEADER FOOD', 'Ahmed BOUDRAA', 1, 5, 0, 5, 0, 7000, 7000, 'HUIT MILLE QUATRE CENTS', 'réalisé', 1, 32, NULL, '2020-11-02 07:54:33', '2021-01-22 09:28:28', 6, NULL),
(159, '14', '106', 'TF9', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-19', '2020-12-19', 1, 'Intra-entreprise', 'Mediexperts', 'LEADER FOOD', 'Ahmed BOUDRAA', 1, 5, 0, 5, 0, 7000, 7000, 'HUIT MILLE QUATRE CENTS', 'réalisé', 1, 32, NULL, '2020-11-02 07:55:45', '2021-01-22 09:28:39', 6, NULL),
(160, '14', '107', 'TF10', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-24', '2020-12-24', 1, 'Intra-entreprise', 'Mediexperts', 'LEADER FOOD', 'Ahmed BOUDRAA', 1, 6, 6, 0, 0, 7000, 7000, 'HUIT MILLE QUATRE CENTS', 'réalisé', 1, 32, NULL, '2020-11-02 07:56:51', '2021-01-22 09:28:47', 6, NULL),
(161, '20', '47', 'TF11', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-25', '2020-12-31', 3, 'Intra-entreprise', 'Mediexperts', 'LEADER FOOD', 'Ahmed BOUDRAA', 1, 5, 0, 5, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 1, 32, NULL, '2020-11-02 07:58:04', '2021-01-22 09:28:54', 6, NULL),
(162, '20', '109', 'TF12', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-07', '2021-01-07', 1, 'Intra-entreprise', 'Mediexperts', 'LEADER FOOD', 'Ahmed BOUDRAA', 1, 6, 0, 6, 0, 7000, 7000, 'HUIT MILLE QUATRE CENTS', 'réalisé', 1, 32, NULL, '2020-11-02 07:59:47', '2021-01-22 09:29:03', 6, NULL),
(163, '29', '110', 'TF13', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-08', '2021-01-08', 1, 'Intra-entreprise', 'Mediexperts', 'LEADER FOOD', 'Ahmed BOUDRAA', 1, 6, 2, 4, 0, 7000, 7000, 'HUIT MILLE QUATRE CENTS', 'réalisé', 1, 32, NULL, '2020-11-02 08:01:21', '2021-01-22 09:29:12', 6, NULL),
(164, '26', '111', 'TF14', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-09', '2021-01-09', 1, 'Intra-entreprise', 'Mediexperts', 'LEADER FOOD', 'Ahmed BOUDRAA', 1, 6, 0, 6, 0, 5000, 5000, 'SIX MILLE', 'réalisé', 1, 32, NULL, '2020-11-02 08:02:13', '2021-01-22 09:26:14', 6, NULL),
(165, '25', '112', 'TF15', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-14', '2021-01-15', 2, 'Intra-entreprise', 'Mediexperts', 'LEADER FOOD', 'Ahmed BOUDRAA', 1, 6, 6, 0, 0, 7000, 14000, 'SEIZE MILLE HUIT CENTS', 'réalisé', 1, 32, NULL, '2020-11-02 08:03:12', '2021-01-22 09:26:25', 6, NULL),
(166, '20', '113', 'TF16', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-16', '2021-01-22', 3, 'Intra-entreprise', 'Mediexperts', 'LEADER FOOD', 'Ahmed BOUDRAA', 1, 5, 0, 5, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 1, 32, NULL, '2020-11-02 08:04:28', '2021-01-22 09:26:39', 6, NULL),
(167, '26', '115', 'TF17', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-01-29', '2021-01-30', 2, 'Intra-entreprise', 'Mediexperts', 'LEADER FOOD', 'Ahmed BOUDRAA', 1, 6, 3, 3, 0, 5000, 10000, 'DOUZE MILLE', 'réalisé', 1, 32, NULL, '2020-11-02 08:05:28', '2021-01-22 09:26:49', 6, NULL),
(168, '14', '114', 'TF18', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-02-05', '2021-02-11', 3, 'Intra-entreprise', 'Mediexperts', 'LEADER FOOD', 'Ahmed BOUDRAA', 1, 5, 0, 5, 0, 7000, 21000, 'VINGT-CINQ MILLE DEUX CENTS', 'réalisé', 1, 32, NULL, '2020-11-02 08:06:15', '2021-01-22 09:26:59', 6, NULL),
(169, '10', '108', 'TF19', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2021-02-12', '2021-02-13', 2, 'Intra-entreprise', 'Mediexperts', 'LEADER FOOD', 'Ahmed BOUDRAA', 1, 6, 6, 0, 0, 7500, 15000, 'DIX-HUIT MILLE', 'réalisé', 1, 32, NULL, '2020-11-02 08:07:09', '2021-01-22 09:27:12', 6, NULL),
(186, '10', '119', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-10-15', '2019-10-16', 2, 'Intra-entreprise', 'Mediexperts', 'Hava Hard Trade', 'Belaid OUJANA', 1, 5, 5, 0, 0, 7500, 15000, 'quinze mille', 'annulé', 1, 33, NULL, '2020-11-11 06:32:47', '2020-12-11 08:13:55', NULL, NULL),
(187, '11', '30', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'préparé', 'non préparé', '2019-10-22', '2019-10-22', 1, 'Intra-entreprise', 'Mediexperts', 'Hava Hard Trade', 'Belaid OUJANA', 1, 5, 5, 0, 0, 7000, 7000, 'sept mille', 'annulé', 18, 33, 'Réalisée par le cabinet VALUE', '2020-11-11 06:34:20', '2020-12-11 08:14:24', NULL, NULL),
(189, '19', '120', 'TF3', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'préparé', 'non préparé', '2019-10-23', '2019-10-23', 1, 'Intra-entreprise', 'Mediexperts', 'Hava Hard Trade', 'Belaid OUJANA', 1, 9, 2, 7, 0, 7000, 7000, 'sept mille', 'annulé', 18, 33, 'Réalisée par le cabinet VALUE', '2020-11-11 06:53:22', '2020-12-11 08:14:37', NULL, NULL),
(190, '10', '121', 'TF4', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'préparé', 'non préparé', '2019-10-29', '2019-10-30', 2, 'Intra-entreprise', 'Mediexperts', 'Hava Hard Trade', 'Belaid OUJANA', 1, 5, 5, 0, 0, 7500, 15000, 'quinze mille', 'annulé', 1, 33, 'Réalisée par le cabinet VALUE, le cout retenu est 14000 (7000/jour)', '2020-11-11 07:24:44', '2020-12-11 08:14:55', NULL, NULL),
(191, '10', '32', 'TF5', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'préparé', 'non préparé', '2019-11-04', '2019-11-05', 2, 'Intra-entreprise', 'Mediexperts', 'Hava Hard Trade', 'Belaid OUJANA', 1, 5, 5, 0, 0, 7500, 15000, 'quinze mille', 'annulé', 1, 33, 'Réalisée par le cabinet Value, le cout retenu est 14000 (7000/jour)', '2020-11-11 07:50:16', '2020-12-11 08:15:10', NULL, NULL),
(192, '11', '122', 'TF6', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'préparé', 'non préparé', '2019-11-19', '2019-11-20', 2, 'Intra-entreprise', 'Mediexperts', 'Hava Hard Trade', 'Belaid OUJANA', 1, 5, 2, 3, 0, 7000, 14000, 'quatorze mille', 'annulé', 6, 33, 'Réalisée par le cabinet Value', '2020-11-11 07:55:03', '2020-12-11 08:15:23', NULL, NULL),
(193, '16', '123', 'TF1', 'préparé', 'non préparé', 'préparé', 'non préparé', 'non préparé', 'préparé', 'non préparé', '2019-10-14', '2019-10-21', 6, 'Intra-entreprise', 'Mediexperts', 'SA.GLOBAL', 'Nabila WARDI', 1, 10, 10, 0, 0, 7000, 42000, 'cinquante mille quatre cents', 'réalisé', 6, 34, NULL, '2020-11-23 12:08:16', '2020-11-23 12:08:16', NULL, NULL),
(199, '16', '31', 'TF3', 'préparé', 'non préparé', 'préparé', 'non préparé', 'non préparé', 'préparé', 'non préparé', '2019-10-22', '2019-10-29', 6, 'Intra-entreprise', 'Mediexperts', 'SA.GLOBAL', 'Nabila WARDI', 1, 6, 6, 0, 0, 7000, 42000, 'cinquante mille quatre cents', 'réalisé', 6, 34, NULL, '2020-11-23 13:26:49', '2020-11-23 13:26:49', NULL, NULL),
(202, '13', '125', 'TF3', 'préparé', 'non préparé', 'préparé', 'non préparé', 'non préparé', 'préparé', 'non préparé', '2019-10-30', '2019-11-07', 6, 'Intra-entreprise', 'Mediexperts', 'SA.GLOBAL', 'Nabila WARDI', 1, 5, 5, 0, 0, 8000, 48000, 'cinquante-sept mille six cents', 'réalisé', 8, 34, NULL, '2020-11-23 13:59:13', '2020-11-23 14:34:39', NULL, NULL),
(203, '13', '126', 'TF4', 'préparé', 'non préparé', 'préparé', 'non préparé', 'non préparé', 'préparé', 'non préparé', '2019-11-08', '2019-11-15', 6, 'Intra-entreprise', 'Mediexperts', 'SA.GLOBAL', 'Nabila WARDI', 1, 5, 5, 0, 0, 8000, 48000, 'CINQUANTE-SEPT MILLE SIX CENTS', 'réalisé', 8, 34, NULL, '2020-11-23 14:39:46', '2020-11-23 14:39:46', NULL, NULL),
(204, '10', '55', 'TF5', 'préparé', 'non préparé', 'préparé', 'non préparé', 'préparé', 'préparé', 'non préparé', '2019-11-19', '2019-11-26', 6, 'Intra-entreprise', 'Mediexperts', 'SA.GLOBAL', 'Nabila WARDI', 1, 6, 6, 0, 0, 7500, 45000, 'CINQUANTE-QUATRE MILLE', 'réalisé', 1, 34, NULL, '2020-11-23 14:41:46', '2020-11-23 14:41:46', NULL, NULL),
(210, '17', '35', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2010-01-01', '2010-01-03', 3, 'Intra-entreprise', 'Mediexperts', 'TEST ENTREPRISE', 'Ahmed Karim', 3, 10, 5, 0, 0, 1000, 6000, 'QUATRE MILLE DEUX CENTS', 'réalisé', 5, 10, NULL, '2020-11-24 07:59:09', '2020-12-30 14:03:09', 12, NULL),
(211, '18', '127', 'TF6', 'préparé', 'préparé', 'préparé', 'non préparé', 'non préparé', 'préparé', 'non préparé', '2019-11-26', '2019-12-31', 6, 'Intra-entreprise', 'Mediexperts', 'SA.GLOBAL', 'Nabila WARDI', 1, 10, 6, 4, 0, 5000, 30000, 'TRENTE-SIX MILLE', 'réalisé', 16, 34, NULL, '2020-11-24 08:48:26', '2020-11-24 08:48:26', NULL, NULL),
(212, '18', '124', 'TF7', 'préparé', 'préparé', 'préparé', 'non préparé', 'non préparé', 'préparé', 'non préparé', '2019-11-26', '2019-12-31', 9, 'Intra-entreprise', 'Mediexperts', 'SA.GLOBAL', 'Nabila WARDI', 1, 15, 11, 4, 0, 5000, 45000, 'CINQUANTE-QUATRE MILLE', 'réalisé', 15, 34, NULL, '2020-11-24 08:50:44', '2020-11-24 08:50:44', NULL, NULL),
(213, '17', '35', 'TF1', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-04', '2020-12-06', 2, 'Intra-entreprise', 'Mediexperts', 'TEST ENTREPRISE', 'Ahmed Karim', 1, 12, 6, 6, 0, 1000, 2000, 'DEUX MILLE QUATRE CENTS', 'planifié', 5, 18, NULL, '2020-12-02 10:32:41', '2020-12-02 13:26:43', NULL, NULL),
(214, '10', '131', 'TF7', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-12-03', '2019-12-03', 1, 'Intra-entreprise', 'Mediexperts', 'Hava Hard Trade', 'Belaid OUJANA', 1, 9, 4, 5, 0, 7500, 7500, 'NEUF MILLE', 'réalisé', 18, 33, NULL, '2020-12-11 10:10:46', '2020-12-24 11:07:18', NULL, NULL),
(215, '11', '132', 'TF8', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-12-10', '2019-12-10', 1, 'Intra-entreprise', 'Mediexperts', 'Hava Hard Trade', 'Belaid OUJANA', 1, 5, 4, 1, 0, 7000, 7000, 'HUIT MILLE QUATRE CENTS', 'réalisé', 18, 33, NULL, '2020-12-11 10:18:23', '2020-12-11 10:18:23', NULL, NULL),
(216, '14', '130', 'TF9', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-12-11', '2019-12-11', 1, 'Intra-entreprise', 'Mediexperts', 'Hava Hard Trade', 'Belaid OUJANA', 1, 9, 4, 5, 0, 7000, 7000, 'HUIT MILLE QUATRE CENTS', 'réalisé', 18, 33, NULL, '2020-12-11 10:25:49', '2020-12-24 11:07:39', NULL, NULL),
(217, '10', '133', 'TF10', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-12-13', '2019-12-13', 1, 'Intra-entreprise', 'Mediexperts', 'Hava Hard Trade', 'Belaid OUJANA', 1, 9, 4, 5, 0, 7500, 7500, 'NEUF MILLE', 'réalisé', 18, 33, NULL, '2020-12-11 10:34:08', '2020-12-24 11:07:55', NULL, NULL),
(218, '15', '134', 'TF11', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-12-17', '2019-12-18', 2, 'Intra-entreprise', 'Mediexperts', 'Hava Hard Trade', 'Belaid OUJANA', 1, 5, 4, 1, 0, 7000, 14000, 'SEIZE MILLE HUIT CENTS', 'réalisé', 17, 33, NULL, '2020-12-11 10:39:11', '2020-12-24 11:07:03', NULL, NULL),
(219, '11', '135', 'TF12', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-12-20', '2019-12-20', 1, 'Intra-entreprise', 'Mediexperts', 'Hava Hard Trade', 'Belaid OUJANA', 1, 5, 4, 1, 0, 7000, 7000, 'HUIT MILLE QUATRE CENTS', 'réalisé', 18, 33, NULL, '2020-12-11 10:46:27', '2020-12-11 10:46:27', NULL, NULL),
(220, '11', '136', 'TF13', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2019-12-24', '2019-12-25', 2, 'Intra-entreprise', 'Mediexperts', 'Hava Hard Trade', 'Belaid OUJANA', 1, 5, 4, 1, 0, 7000, 14000, 'SEIZE MILLE HUIT CENTS', 'réalisé', 18, 33, NULL, '2020-12-11 10:54:45', '2020-12-11 10:54:45', NULL, NULL),
(221, '17', '35', 'TF2', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', 'non préparé', '2020-12-29', '2020-12-31', 5, 'Intra-entreprise', 'Mediexperts', 'TEST ENTREPRISE', 'Ahmed Karim', 1, 5, 5, 0, 0, 1000, 5000, 'SIX MILLE', 'planifié', 1, 10, NULL, '2020-12-29 13:02:21', '2020-12-29 13:05:32', NULL, NULL);
...
(137, 'Législation du travail', '- Maîtriser les bases de la réglementation en droit social \r\n-Appliquer le droit du travail -Gérer efficacement les dossiers du personnel', 'Code du travail \r\n- Conventions et accords collectifs \r\n- Les usages d’entreprise. \r\n- Les obligations légales liées à l’embauche \r\n- Les différents contrats de travail \r\n- La durée du travail \r\n- Le bulletin de paie \r\n- Les compléments du salaire \r\n- Les principales absences \r\n- Les sanctions \r\n- La rupture du contrat de travail \r\n- La formation professionnelle : le point sur la réforme', NULL, 33, '2021-02-12 11:51:44', '2021-02-12 11:51:44'),
(138, 'Législation du travail', '- Maîtriser les bases de la réglementation en droit social \r\n-Appliquer le droit du travail -Gérer efficacement les dossiers du personnel', 'Code du travail \r\n- Conventions et accords collectifs \r\n- Les usages d’entreprise. \r\n- Les obligations légales liées à l’embauche \r\n- Les différents contrats de travail \r\n- La durée du travail \r\n- Le bulletin de paie \r\n- Les compléments du salaire \r\n- Les principales absences \r\n- Les sanctions \r\n- La rupture du contrat de travail \r\n- La formation professionnelle : le point sur la réforme', 'Modification nomenclature settat (-> cout de casa)', 34, '2021-02-12 13:28:34', '2021-02-12 13:28:34');
...
(2, 'Masti', 'Anas', 'anasmasti@hotmail.com', '2020-07-24 05:02:21', '$2y$10$l2zkC0V1VwMHS90Zfq6GHuzP5ZfePDgHifsm5bLCmyLGj7kkFdARq', 'img/user/1595584919-photo.png', 'admin', 'Jfny3LVcEz230iB1Sm5LbebWQ6ErUTTaVmgJhHSi3Qul0uxqbfcbqhsN1OJW', '2020-07-24 05:01:59', '2020-07-24 05:02:21'),
...
(10, 'Nacer', 'Oumaima', 'o.nacer@mediexperts.ma', '2020-12-17 10:40:48', '$2y$10$sTMj3n.ST6Ucwu8jsdab7uQLMU9k6Yj84W5KQntGm7gXabO2zvwc2', 'img/user/1608205235-photo.jpg', 'user', 'Gd62Rk8ykdQourgvsxQiFz3lag8NUSZpXlyUi2f5uoG95GsO1Lt8F55SAwGU', '2020-12-17 10:40:35', '2020-12-17 10:40:48');
...
--
-- Index pour la table `old_action_formations`
--
ALTER TABLE `old_action_formations`
  ADD PRIMARY KEY (`old_n_form`),
  ADD KEY `old_action_formations_old_id_inv_foreign` (`old_id_inv`),
  ADD KEY `old_action_formations_old_id_plan_foreign` (`old_id_plan`);

--
-- Index pour la table `old_formations`
--
ALTER TABLE `old_formations`
  ADD PRIMARY KEY (`old_id_form`),
  ADD KEY `old_formations_old_id_inv_foreign` (`old_id_inv`),
  ADD KEY `old_formations_old_n_form_foreign` (`old_n_form`);
...
--
ALTER TABLE `demande_financements`
  MODIFY `n_df` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT pour la table `demande_remboursement_giacs`
--
ALTER TABLE `demande_remboursement_giacs`
  MODIFY `n_drb` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
--
ALTER TABLE `domaines`
  MODIFY `id_domain` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
-- AUTO_INCREMENT pour la table `old_action_formations`
--
ALTER TABLE `old_action_formations`
  MODIFY `old_n_form` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `old_formations`
--
ALTER TABLE `old_formations`
  MODIFY `old_id_form` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `themes`
  MODIFY `id_theme` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=139;
...
--
-- Contraintes pour la table `old_action_formations`
--
ALTER TABLE `old_action_formations`
  ADD CONSTRAINT `old_action_formations_old_id_inv_foreign` FOREIGN KEY (`old_id_inv`) REFERENCES `intervenants` (`id_interv`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `old_action_formations_old_id_plan_foreign` FOREIGN KEY (`old_id_plan`) REFERENCES `plans` (`id_plan`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `old_formations`
--
ALTER TABLE `old_formations`
  ADD CONSTRAINT `old_formations_old_id_inv_foreign` FOREIGN KEY (`old_id_inv`) REFERENCES `intervenants` (`id_interv`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `old_formations_old_n_form_foreign` FOREIGN KEY (`old_n_form`) REFERENCES `old_action_formations` (`old_n_form`) ON DELETE CASCADE ON UPDATE CASCADE;
